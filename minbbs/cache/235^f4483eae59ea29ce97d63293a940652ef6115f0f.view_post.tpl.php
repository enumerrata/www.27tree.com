...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d36234080ca8_46422168',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d36234080ca8_46422168')) {function content_52d36234080ca8_46422168($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>高数公式</title>
        <meta name="description" content="高数公式:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="235" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">高数公式</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年11月14日 23:42</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	<img src="/mod/kd/attached/image/20121114/20121114234141_69629.gif" alt="" />
</p>
<p>
	<br />
</p></div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/73_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/73">_后觉</a> / 2012年11月14日 23:42 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="73">回复</a></div><p>
	它其实可以这样的
<pre name="code" id="prettyprint" class="Java">var total = 0;
for(int i = n; i <= m; i++)
{
   total +=  f(i)
}</pre>
