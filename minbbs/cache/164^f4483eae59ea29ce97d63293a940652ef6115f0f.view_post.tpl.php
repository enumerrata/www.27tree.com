...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4a00863be35_60017129',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4a00863be35_60017129')) {function content_52d4a00863be35_60017129($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>CSS3 各种教程</title>
        <meta name="description" content="CSS3 各种教程:
	http://www.itsrcs.com/online/tri-5/sec-1.html
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="164" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">CSS3 各种教程</h1>
                        <span id="vps-title-info">由 <a href="/user/12">坑爹的程序员</a> 发表于 2012年10月18日 16:49</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/73_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/73">_后觉</a> / 2012年10月18日 18:41 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="73">回复</a></div>有教程有代码，为什么不弄上一个效果图<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/73">后觉゛</a>&nbsp;：有空再弄了///<span class="block Gray">2012年10月18日 21:29 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/73_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/73">%E5%90%8E%E8%A7%89%E3%82%9B</a> @ <a href="/user/2">koodo</a>&nbsp;：你到底注册了几个帐号<span class="block Gray">2012年10月18日 23:11 / <a href="javascript:;" rel="1" actUID="73" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/73">后觉゛</a>&nbsp;：我也不知道<span class="block Gray">2012年10月18日 23:44 / <a href="javascript:;" rel="2" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
