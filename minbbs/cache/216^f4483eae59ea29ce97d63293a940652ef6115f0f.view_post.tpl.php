...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d544eddc16c2_75803833',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d544eddc16c2_75803833')) {function content_52d544eddc16c2_75803833($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>网站名字太难记了</title>
        <meta name="description" content="网站名字太难记了:有没有什么好名字啊" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="216" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">网站名字太难记了</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2012年11月8日 16:09</span>
                    </div>

                    <div class="autowarp" id="vps-content">有没有什么好名字啊</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/29">human</a> / 2012年11月8日 16:11 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="29">回复</a></div>现在我都记熟了！<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/32_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/32">mallocx</a> @ <a href="/user/29">human</a>&nbsp;：主要是柿太难打了<span class="block Gray">2012年11月8日 16:13 / <a href="javascript:;" rel="0" actUID="32" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/32_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/32">mallocx</a> @ <a href="/user/29">human</a>&nbsp;：要不搞个回复可见的功能，然后发发美女图片的帖子，不然没人气<span class="block Gray">2012年11月8日 16:14 / <a href="javascript:;" rel="1" actUID="32" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/32">mallocx</a>&nbsp;：的确很难打·要连打才好<span class="block Gray">2012年11月8日 16:42 / <a href="javascript:;" rel="2" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/32">mallocx</a>&nbsp;：的确很难打·要连打才好<span class="block Gray">2012年11月8日 16:42 / <a href="javascript:;" rel="3" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
