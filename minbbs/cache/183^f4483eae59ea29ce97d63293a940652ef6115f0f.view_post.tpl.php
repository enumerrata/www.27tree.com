...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5449c4b9121_27668269',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5449c4b9121_27668269')) {function content_52d5449c4b9121_27668269($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>解决vsftpd 530 Permission denied</title>
        <meta name="description" content="解决vsftpd 530 Permission denied:
	使用在vsftpd.conf中添加userlist_*阻止特定的本地用户&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;


	userlist_enable=YES&nbsp;&nbsp;&nbsp;&nbsp;&nbsp" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="183" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">解决vsftpd 530 Permission denied</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年10月25日 17:12</span>
                    </div>
