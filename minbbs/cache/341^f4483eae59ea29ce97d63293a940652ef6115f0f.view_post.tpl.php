...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d623667df745_22156738',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d623667df745_22156738')) {function content_52d623667df745_22156738($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>分享几个流行Js库 的CDN地址</title>
        <meta name="description" content="分享几个流行Js库 的CDN地址:
	Dojo&nbsp;&lt;scriptsrc="//ajax.googleapis.com/ajax/libs/dojo/1.9.0/dojo/dojo.js"&gt;&lt;/script&gt;
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="341" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">分享几个流行Js库 的CDN地址</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2013年5月13日 19:05</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	Dojo&nbsp;&lt;script src="//ajax.googleapis.com/ajax/libs/dojo/1.9.0/dojo/dojo.js"&gt;&lt;/script&gt;
</p>
<p>
	<br />
</p>
<p>
	Ext Core&nbsp;&lt;script src="//ajax.googleapis.com/ajax/libs/ext-core/3.1.0/ext-core.js"&gt;&lt;/script&gt;
</p>
<p>
	<br />
</p>
...
<p>
	jQuery UI&nbsp;&lt;script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"&gt;&lt;/script&gt;
</p>
<p>
	<br />
</p>
...
<p>
	这些都是Google提供的CDN分发，建议大家使用CDN加载Js库，这样比较快哈。
</p></div>
                </div>
