...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d36ef9717820_14068951',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d36ef9717820_14068951')) {function content_52d36ef9717820_14068951($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>改版了？发个帖子看看怎么样</title>
        <meta name="description" content="改版了？发个帖子看看怎么样:貌似不错，快了点" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="292" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">改版了？发个帖子看看怎么样</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2012年12月20日 17:36</span>
                    </div>

                    <div class="autowarp" id="vps-content">貌似不错，快了点</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/151_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/151">鸡仔食饭米</a> / 2012年12月21日 11:23 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="151">回复</a></div>嗯 真的是快了点<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年12月23日 15:10 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>是么<div class="cms"></div></div></div></div>
