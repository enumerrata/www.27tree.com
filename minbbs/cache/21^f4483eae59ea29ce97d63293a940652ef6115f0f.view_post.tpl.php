...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d51d7d20db51_91820260',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d51d7d20db51_91820260')) {function content_52d51d7d20db51_91820260($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>KOODO</title>
        <meta name="description" content="KOODO:KOODO你大爷的请抽机，还钱" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="21" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">KOODO</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年8月14日 15:30</span>
                    </div>

                    <div class="autowarp" id="vps-content">KOODO你大爷的请抽机，还钱<img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0036.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年8月14日 15:32 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>没钱没钱没 钱 <img src="/mod/kd/plugins/emoticons/images/tsj/t_0039.gif" border="0" alt="" /><div class="cms"></div></div></div></div>
