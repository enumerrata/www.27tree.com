...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4c3cb28d780_89252090',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4c3cb28d780_89252090')) {function content_52d4c3cb28d780_89252090($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Ubuntu下Apache启用Rewrite伪静态 </title>
        <meta name="description" content="Ubuntu下Apache启用Rewrite伪静态 :
	&gt;&nbsp;sudoa2enmodrewrite开启Rewrite模块&nbsp;


	&gt;sudoserviceapache2restart


	&gt;sudogedit/etc/apache2/sites-avai" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="187" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Ubuntu下Apache启用Rewrite伪静态 </h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年10月28日 11:31</span>
                    </div>
