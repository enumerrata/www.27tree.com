...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d21ddb573f31_81302313',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d21ddb573f31_81302313')) {function content_52d21ddb573f31_81302313($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>冬季防静电小窍门</title>
        <meta name="description" content="冬季防静电小窍门:
	1.室内要保持一定的湿度。除了经常通风换气外，要勤拖地或者放些盆栽花草；


	2.尽量避免穿化纤的衣服。洗衣服时可以使用防静电的洗涤剂。


	3.使用保湿性能好的护肤品，以保证皮肤的水分；勤洗澡、勤换衣服。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="241" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">冬季防静电小窍门</h1>
                        <span id="vps-title-info">由 <a href="/user/19">Serria</a> 发表于 2012年11月19日 21:54</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年12月27日 10:07 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>静电而已嘛<div class="cms"></div></div></div></div>
