...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61cea159de8_96412981',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61cea159de8_96412981')) {function content_52d61cea159de8_96412981($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>蛋疼</title>
        <meta name="description" content="蛋疼:一直在做网站·公司网站就快建好了··头发都白几根了·胡子也长了·蛋疼啊·" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="261" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">蛋疼</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年12月4日 15:35</span>
                    </div>

                    <div class="autowarp" id="vps-content">一直在做网站·公司网站就快建好了··头发都白几根了·胡子也长了·蛋疼啊·<img src="/mod/kd/plugins/emoticons/images/tsj/t_0022.gif" border="0" alt="" /></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/32_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/32">mallocx</a> / 2012年12月4日 16:15 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="32">回复</a></div>不是头发都没几根了吗<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/32">mallocx</a>&nbsp;：天天睡觉掉头发啊·坑爹啊··哥都憔悴死了！！<span class="block Gray">2012年12月4日 17:54 / <a href="javascript:;" rel="0" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/73_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/73">%E5%90%8E%E8%A7%89%E3%82%9B</a> @ <a href="/user/32">mallocx</a>&nbsp;：洗澡的时候掉头发，厕所都快塞了<span class="block Gray">2012年12月5日 13:45 / <a href="javascript:;" rel="1" actUID="73" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/32_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/32">mallocx</a> @ <a href="/user/73">后觉゛</a>&nbsp;：哈哈<span class="block Gray">2012年12月5日 17:48 / <a href="javascript:;" rel="2" actUID="32" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
