...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d56a1871cab9_48987237',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d56a1871cab9_48987237')) {function content_52d56a1871cab9_48987237($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>你最常用的十条命令</title>
        <meta name="description" content="你最常用的十条命令:
history|awk'{CMD[$2]++;count++;}END{for(ainCMD)printCMD""CMD/count*100"%"a}'|grep-v"./"|column-c3-s""-t|sort-nr|nl|head" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="249" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">你最常用的十条命令</h1>
                        <span id="vps-title-info">由 <a href="/user/66">影子</a> 发表于 2012年11月22日 22:45</span>
                    </div>

                    <div class="autowarp" id="vps-content"><br />
<pre name="code" id="prettyprint" class="bsh">history | awk '{CMD[$2]++;count++;} END { for (a in CMD )print CMD " " CMD/count*100 "% " a }' | grep -v "./" | column -c3 -s " " -t | sort -nr | nl | head -n10 </pre>
<p>
	<span style="font-size:24px;">&nbsp;&nbsp;&nbsp;&nbsp;
运行这行脚本可以找出统计出你最常用的十条命令，原作者甚至说通过这一行脚本可以洞察出你是一个怎样的程序员。</span> 
</p>
<p>
	<span style="font-size:24px;">&nbsp;&nbsp;&nbsp; </span><span style="font-size:24px;">运行了一下，输出结果相当神奇。</span> 
</p>
<p>
	<span style="font-size:24px;">&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="font-size:24px;">感谢原创作者</span><img src="/mod/kd/plugins/emoticons/images/jx2/j_0003.gif" alt="" border="0" /> 
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/66_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/66">影子</a> / 2012年11月22日 22:59 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="66">回复</a></div><pre name="code" id="prettyprint" class="bsh">     1	41  10%        ls
     2	29  7.07317%   ssh
     3	29  7.07317%   cd
     4	17  4.14634%   nmap
     5	16  3.90244%   cls
     6	16  3.90244%   apt-get
     7	15  3.65854%   ip
     8	14  3.41463%   ifconfig
     9	13  3.17073%   virtualbox
    10	13  3.17073%   rm</pre>
<br /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年11月23日 00:32 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>还有比例啊，木有键盘怎么办<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/66_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/66">%E5%BD%B1%E5%AD%90</a> @ <a href="/user/2">koodo</a>&nbsp;：你用眼神输入命令吗？<span class="block Gray">2012年11月24日 16:31 / <a href="javascript:;" rel="0" actUID="66" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/66">影子</a>&nbsp;：用耳朵<span class="block Gray">2012年11月25日 12:26 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
