...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d505723aa4b1_77703733',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d505723aa4b1_77703733')) {function content_52d505723aa4b1_77703733($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Ubuntu安装Google Chrome浏览器</title>
        <meta name="description" content="Ubuntu安装Google Chrome浏览器:
	Ubuntu软件中心里面没有GoogleChrome浏览器，而是其分支Chromium，如果你想用原汁原味的Chrome，可以在Google网站上下载。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="338" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Ubuntu安装Google Chrome浏览器</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2013年4月24日 14:57</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	Ubuntu 软件中心里面没有Google Chrome浏览器，而是其分支Chromium，如果你想用原汁原味的Chrome，可以在Google网站上下载。
</p>
<p>
	下载地址：<strong>http://www.google.com/chrome</strong>
</p>
<p>
	下载完成之后，可以使用下面的命令进行安装，也可以双击安装。
</p>
<p>
	<br />
</p>
<p>
	cd Downloads/ 注：制定到下载目录下。
</p>
<p>
...
<p>
	<span style="color:#E53333;"><strong>运行如果出现错误，运行下面的命令：</strong></span>
</p>
<p>
