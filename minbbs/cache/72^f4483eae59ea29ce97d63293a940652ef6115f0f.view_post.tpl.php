...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d3bdafedca85_07956273',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d3bdafedca85_07956273')) {function content_52d3bdafedca85_07956273($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Hello, I'm Obama</title>
        <meta name="description" content="Hello, I'm Obama:“As&nbsp;long&nbsp;as&nbsp;we&nbsp;have&nbsp;a&nbsp;single&nbsp;American&nbsp;in&nbsp;harm’s&nbsp;way,&nbsp;we&nbsp;will" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="72" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/101"><img src="/user/data/head-img/101_head.jpg"/><span id="author-nickname">Obama</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Hello, I'm Obama</h1>
                        <span id="vps-title-info">由 <a href="/user/101">Obama</a> 发表于 2012年9月4日 18:29</span>
                    </div>

                    <div class="autowarp" id="vps-content">“As&nbsp;long&nbsp;as&nbsp;we&nbsp;have&nbsp;a&nbsp;single&nbsp;American&nbsp;in&nbsp;harm’s&nbsp;way,&nbsp;we&nbsp;will&nbsp;continue&nbsp;to&nbsp;do&nbsp;everything&nbsp;in&nbsp;our&nbsp;power&nbsp;to&nbsp;keep&nbsp;them&nbsp;safe&nbsp;and&nbsp;help&nbsp;them&nbsp;succeed.”</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月4日 18:31 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>O my god!<img src="/mod/kd/plugins/emoticons/images/jx2/j_0004.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/19">Serria</a> / 2012年9月4日 18:46 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="19">回复</a></div>Oh,no.God is crazy.<img src="/mod/kd/plugins/emoticons/images/jx2/j_0003.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/29">human</a> / 2012年9月4日 20:07 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="29">回复</a></div>Fuck!!<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/78_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/78">Sohol</a> / 2012年9月4日 21:15 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="78">回复</a></div>Absolutely right！！！<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/78">Sohol</a>&nbsp;：zhuangbing?<span class="block Gray">2012年9月4日 23:15 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/2">koodo</a>&nbsp;：Agree。<span class="block Gray">2012年9月5日 09:30 / <a href="javascript:;" rel="1" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">5&#x697C; / <a href="/user/29">human</a> / 2012年9月4日 23:01 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="4" actUID="29">回复</a></div><p>
	ni zai shuo shen me`neng bu neng shuo zhong wen(chinese)！！！！
</p>
<p>
	JJ fly(屌飞了) 
