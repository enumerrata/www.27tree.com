...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d59345e4bc39_07049148',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d59345e4bc39_07049148')) {function content_52d59345e4bc39_07049148($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>避免 json_encode 中文产生 unicode 转义</title>
        <meta name="description" content="避免 json_encode 中文产生 unicode 转义:
	在PHP5.4&nbsp;Json新增了一个选项:JSON_UNESCAPED_UNICODE,故名思议,就是说,Json不要编码Unicode.
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="196" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">避免 json_encode 中文产生 unicode 转义</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年11月1日 00:24</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	在PHP5.4&nbsp;Json 新增了一个选项: JSON_UNESCAPED_UNICODE, 故名思议, 就是说, Json不要编码Unicode.
</p>
<p>
	看下面的例子:
</p>
...
<p>
	同时&nbsp;Json在5.4还加入了: JSON_BIGINT_AS_STRING, JSON_PRETTY_PRINT, JSON_UNESCAPED_SLASHES等选项
</p></div>
                </div>
