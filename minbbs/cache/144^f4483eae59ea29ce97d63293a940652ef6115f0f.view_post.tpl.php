...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d6234990aa00_88614021',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d6234990aa00_88614021')) {function content_52d6234990aa00_88614021($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>5个字符</title>
        <meta name="description" content="5个字符:注册要至少5个字符，所以我就成了王月月鸟。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="144" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/156"><img src="/img/tavatar.gif"/><span id="author-nickname">王月月鸟。</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">5个字符</h1>
                        <span id="vps-title-info">由 <a href="/user/156">王月月鸟。</a> 发表于 2012年10月11日 19:13</span>
                    </div>

                    <div class="autowarp" id="vps-content">注册要至少5个字符，所以我就成了王月月鸟。<img src="/mod/kd/plugins/emoticons/images/jx2/j_0033.gif" border="0" alt="" /></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年10月11日 21:08 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>句号也算？<div class="cms"></div></div></div></div>
