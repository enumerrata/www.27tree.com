...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d50085120965_81583915',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d50085120965_81583915')) {function content_52d50085120965_81583915($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>使用 正则表达式 压缩HTML文件</title>
        <meta name="description" content="使用 正则表达式 压缩HTML文件:
...
publicfunctioncompress_html($string){
$string=str_repla" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="308" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">使用 正则表达式 压缩HTML文件</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2013年1月31日 16:52</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default15.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/340">怎么可以这样</a> / 2013年2月13日 13:07 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="340">回复</a></div>去除注释那么多正则啊<div class="cms"></div></div></div></div>
