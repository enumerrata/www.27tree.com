...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4fb5dead792_01352770',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4fb5dead792_01352770')) {function content_52d4fb5dead792_01352770($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>发个爱国的帖子。</title>
        <meta name="description" content="发个爱国的帖子。:钓鱼岛是中国的，苍井空是我们大家的，打到日本，拿回我们的钓鱼岛，夺回大家的苍井空！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="80" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/34"><img src="/minbbs/default/headimg/default4.jpg"/><span id="author-nickname">cetian</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">发个爱国的帖子。</h1>
                        <span id="vps-title-info">由 <a href="/user/34">cetian</a> 发表于 2012年9月5日 15:30</span>
                    </div>

                    <div class="autowarp" id="vps-content"><img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0023.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/>钓鱼岛是中国的，苍井空是我们大家的，打到日本，拿回我们的钓鱼岛，夺回大家的苍井空<img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0035.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/>！</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月5日 15:44 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>神了<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/2">koodo</a>&nbsp;：下<span class="block Gray">2012年9月5日 16:21 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/19">Serria</a> / 2012年9月5日 18:41 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="19">回复</a></div>真想这样啊！！！<img src="/mod/kd/plugins/emoticons/images/jx2/j_0002.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/19">Serria</a>&nbsp;：不想，哈哈<span class="block Gray">2012年9月5日 22:33 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：你不想才怪了<span class="block Gray">2012年9月6日 14:50 / <a href="javascript:;" rel="1" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
