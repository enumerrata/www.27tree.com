...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d437520428b9_25766056',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d437520428b9_25766056')) {function content_52d437520428b9_25766056($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>程序员的岗位职责</title>
        <meta name="description" content="程序员的岗位职责:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="124" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">程序员的岗位职责</h1>
                        <span id="vps-title-info">由 <a href="/user/12">坑爹的程序员</a> 发表于 2012年10月2日 09:07</span>
                    </div>
...
<div>
	<span&nbsp;style="font-family:arial,&nbsp;宋体,&nbsp;sans-serif;font-size:13.63636302947998px;line-height:24px;white-space:normal;background-color:#FFFFFF;"><br&nbsp;/>
</span>
</div></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/img/tavatar.gif" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/268">JJyyBB</a> / 2012年12月9日 10:56 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="268">回复</a></div>很详细<div class="cms"></div></div></div></div>
