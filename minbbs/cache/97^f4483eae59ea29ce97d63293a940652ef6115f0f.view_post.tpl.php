...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d621bc540b33_67681875',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d621bc540b33_67681875')) {function content_52d621bc540b33_67681875($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>国庆哥放11天假</title>
        <meta name="description" content="国庆哥放11天假:哈哈哈·哈哈哈·超长的假期！可以玩很久了！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="97" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">国庆哥放11天假</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年9月12日 10:41</span>
                    </div>

                    <div class="autowarp" id="vps-content">哈哈哈·哈哈哈·超长的假期！可以玩很久了！<img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0023.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default15.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/37">_KOODO</a> / 2012年9月12日 12:26 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="37">回复</a></div>我每天都放假<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/19">Serria</a> / 2012年9月12日 13:17 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="19">回复</a></div>切，不屑。<div class="cms"></div></div></div></div>
