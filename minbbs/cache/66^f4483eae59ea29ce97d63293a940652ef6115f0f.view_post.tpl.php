...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d502936e4021_36516833',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d502936e4021_36516833')) {function content_52d502936e4021_36516833($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>用户群增多了</title>
        <meta name="description" content="用户群增多了:用户群逐渐增多咯，是个好现象啊。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="66" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">用户群增多了</h1>
                        <span id="vps-title-info">由 <a href="/user/19">Serria</a> 发表于 2012年9月3日 21:17</span>
                    </div>

                    <div class="autowarp" id="vps-content">用户群逐渐增多咯，是个好现象啊。</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月3日 21:45 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>那肯定了<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/2">koodo</a>&nbsp;：很好啊，说明你的努力慢慢在回报当中啊。加油啊，我永远是你的强力后盾啊。给你最大的支持，加油。<span class="block Gray">2012年9月3日 22:53 / <a href="javascript:;" rel="0" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：哥都起鸡皮了。<span class="block Gray">2012年9月4日 10:18 / <a href="javascript:;" rel="1" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/31">%E4%B8%8D%E6%98%AF%E6%89%93%E9%85%B1%E6%B2%B9%E7%9A%84%E8%B7%AF%E4%BA%BA%E7%94%B2</a> @ <a href="/user/2">koodo</a>&nbsp;：我什么都没看到…………………………<span class="block Gray">2012年9月12日 14:15 / <a href="javascript:;" rel="2" actUID="31" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/19">Serria</a>&nbsp;：汗，肉麻啊亲。<span class="block Gray">2012年9月12日 15:12 / <a href="javascript:;" rel="3" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
