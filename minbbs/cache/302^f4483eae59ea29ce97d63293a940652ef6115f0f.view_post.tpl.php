...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5701c0fa1f3_97740746',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5701c0fa1f3_97740746')) {function content_52d5701c0fa1f3_97740746($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>JQuery让input从disabled变成enabled</title>
        <meta name="description" content="JQuery让input从disabled变成enabled:
	document.getElementById("removeButton").disabled=false;//普通Js写法


	$("#removeButton").removeAttr("disabled");//要变成Enab" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="302" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">JQuery让input从disabled变成enabled</h1>
                        <span id="vps-title-info">由 <a href="/user/300">rewsss</a> 发表于 2013年1月4日 13:41</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/img/tavatar.gif" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/120">luwy90</a> / 2013年3月7日 17:11 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="120">回复</a></div><ol>
	<li>
		<span style="font-size:12px;line-height:1.5;"></span><span style="font-size:12px;line-height:1.5;">很好</span>
	</li>
	<li>
		<span style="font-size:12px;line-height:1.5;">非常好</span>
	</li>
	<li>
		<span style="font-size:12px;line-height:1.5;">非常非常好</span>
	</li>
	<li>
		<span style="font-size:12px;line-height:1.5;">好的不行了啊</span>
	</li>
	<li>
		<span style="font-size:12px;line-height:1.5;">........</span>
	</li>
</ol><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2013年3月7日 18:51 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>............<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2013年3月19日 21:23 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0025.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/2">koodo</a> / 2013年3月19日 21:23 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0025.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">5&#x697C; / <a href="/user/2">koodo</a> / 2013年3月19日 21:23 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="4" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0025.gif" border="0" alt="" /><div class="cms"></div></div></div></div>
