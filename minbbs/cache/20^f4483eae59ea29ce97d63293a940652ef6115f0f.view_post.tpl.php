...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d37a96465a35_29764551',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d37a96465a35_29764551')) {function content_52d37a96465a35_29764551($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>又被百度K了</title>
        <meta name="description" content="又被百度K了:KKKKKK吧，不信度爷了。我泡谷哥去。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="20" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">又被百度K了</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年8月14日 15:29</span>
                    </div>

                    <div class="autowarp" id="vps-content">KKKKKK吧，不信度爷了。我泡谷哥去。<img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0003.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default0.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/58">outfi</a> / 2012年8月17日 20:34 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="58">回复</a></div>度娘 好过姑爷啊<img src="/mod/kd/plugins/emoticons/images/jx2/j_0006.gif" border="0" alt="" /><div class="cms"></div></div></div></div>
