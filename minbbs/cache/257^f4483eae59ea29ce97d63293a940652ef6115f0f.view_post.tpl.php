...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5067242ce92_65763422',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5067242ce92_65763422')) {function content_52d5067242ce92_65763422($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>搞前端的都来看看，你有这个技术吗</title>
        <meta name="description" content="搞前端的都来看看，你有这个技术吗:
	http://www.music.mcgill.ca/~sinclair/content/blog/liquid_simulator_ported_to_canvas


	HTML5哦，开Chrome来浏览吧，记得把鼠标放里面，按鼠标" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="257" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">搞前端的都来看看，你有这个技术吗</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年11月30日 00:29</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	<a href="http://www.music.mcgill.ca/~sinclair/content/blog/liquid_simulator_ported_to_canvas" target="_blank">http://www.music.mcgill.ca/~sinclair/content/blog/liquid_simulator_ported_to_canvas</a>
</p>
<p>
	HTML5哦，开Chrome来浏览吧，记得把鼠标放里面，按鼠标左键
</p></div>
                </div>
