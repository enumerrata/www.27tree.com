...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52cbe6e6af83c3_36624555',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52cbe6e6af83c3_36624555')) {function content_52cbe6e6af83c3_36624555($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Function 神一样的名字</title>
        <meta name="description" content="Function 神一样的名字:太叼了" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="304" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/309"><img src="/user/data/head-img/309_head.jpg"/><span id="author-nickname">Function</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Function 神一样的名字</h1>
                        <span id="vps-title-info">由 <a href="/user/309">Function</a> 发表于 2013年1月8日 00:29</span>
                    </div>

                    <div class="autowarp" id="vps-content">太叼了<img src="/mod/kd/plugins/emoticons/images/jx2/j_0015.gif" border="0" alt="" /></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2013年1月10日 11:15 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0001.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default15.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/340">怎么可以这样</a> / 2013年2月13日 13:08 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="340">回复</a></div>怎么可以这样<div class="cms"></div></div></div></div>
