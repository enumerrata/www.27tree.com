...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d502113f3db3_97862902',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d502113f3db3_97862902')) {function content_52d502113f3db3_97862902($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>MongoDB和MySQL常用语法对比</title>
        <meta name="description" content="MongoDB和MySQL常用语法对比:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="277" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">MongoDB和MySQL常用语法对比</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2012年12月14日 08:10</span>
                    </div>

                    <div class="autowarp" id="vps-content"><div style="text-align:center;">
	<img src="/mod/kd/attached/image/20121214/20121214081009_67686.jpg" alt="" />
</div></div>
                </div>
