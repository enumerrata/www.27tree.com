...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d62260605c78_53506739',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d62260605c78_53506739')) {function content_52d62260605c78_53506739($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>组队打球</title>
        <meta name="description" content="组队打球:有没人打篮球啊，星期三下午没课啊。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="67" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">组队打球</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月3日 22:27</span>
                    </div>

                    <div class="autowarp" id="vps-content">有没人打篮球啊，星期三下午没课啊。<img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0016.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
