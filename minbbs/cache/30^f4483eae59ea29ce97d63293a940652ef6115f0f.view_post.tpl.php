...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d20c6c194541_35403694',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d20c6c194541_35403694')) {function content_52d20c6c194541_35403694($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>有没有人用过论坛的搜索？</title>
        <meta name="description" content="有没有人用过论坛的搜索？:那个是谷歌的自定义搜索，我怎么感觉加载速度那么慢呢？" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="30" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">有没有人用过论坛的搜索？</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年8月18日 07:44</span>
                    </div>

                    <div class="autowarp" id="vps-content">那个是谷歌的自定义搜索，我怎么感觉加载速度那么慢呢？</div>
                </div>
