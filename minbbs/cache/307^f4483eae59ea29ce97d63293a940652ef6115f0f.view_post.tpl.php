...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61cd1b2bee7_16698991',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61cd1b2bee7_16698991')) {function content_52d61cd1b2bee7_16698991($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>用户系统调整，现在只能注册，没有登录按钮，哈哈哈，准备迎接强大的社区吧。</title>
        <meta name="description" content="用户系统调整，现在只能注册，没有登录按钮，哈哈哈，准备迎接强大的社区吧。:我不是标题哈哈" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="307" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">用户系统调整，现在只能注册，没有登录按钮，哈哈哈，准备迎接强大的社区吧。</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2013年1月14日 16:50</span>
                    </div>

                    <div class="autowarp" id="vps-content">我不是标题哈哈</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default2.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/318">resory</a> / 2013年1月17日 17:02 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="318">回复</a></div>支持一下~~<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/31">不是打酱油的路人甲</a> / 2013年1月19日 18:00 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="31">回复</a></div>纳尼<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/29">human</a> / 2013年1月26日 17:48 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="29">回复</a></div><img src="/mod/kd/plugins/emoticons/images/tsj/t_0033.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/img/tavatar.gif" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/382">Diors</a> / 2013年2月28日 18:22 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="382">回复</a></div>靠，qq登录不行了<img src="/mod/kd/plugins/emoticons/images/jx2/j_0004.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">5&#x697C; / <a href="/user/2">koodo</a> / 2013年2月28日 18:26 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="4" actUID="2">回复</a></div>不是不行了,是暂停了<div class="cms"></div></div></div></div>
