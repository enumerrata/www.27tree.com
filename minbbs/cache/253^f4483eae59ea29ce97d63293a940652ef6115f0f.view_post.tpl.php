...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d60ac0c361e5_61425589',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d60ac0c361e5_61425589')) {function content_52d60ac0c361e5_61425589($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>几个方法解决IE6边框短线现象</title>
        <meta name="description" content="几个方法解决IE6边框短线现象:
	今天在工作中碰到一个很奇怪的问题，在测试兼容性的时候，出现了在IE6下面拖动滚动条，两边边框的线会出现断开的现象，很是奇怪。


	查阅了网上资料终于了解明白：IE6边框属性左右出现断线现象原因条件：容器内有两个浮动，并用CLEAR清除" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="253" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">几个方法解决IE6边框短线现象</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年11月28日 13:42</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年11月28日 16:41 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>回来看一下原来打错字<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default20.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/253">LEVT_SSD</a> / 2012年11月28日 16:55 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="253">回复</a></div>我也有遇过这种问题<div class="cms"></div></div></div></div>
