...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d50602396bc3_01251013',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d50602396bc3_01251013')) {function content_52d50602396bc3_01251013($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>建议投诉联系管理员</title>
        <meta name="description" content="建议投诉联系管理员:
	投诉建议，有需要软件方面，或者阅读方面的资料可以联系管理员
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="168" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">建议投诉联系管理员</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年10月22日 10:12</span>
                    </div>
...
<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=990383745&amp;site=qq&amp;menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:990383745:41" alt="点击这里给我发消息" title="点击这里给我发消息" /></a></div>
                </div>
