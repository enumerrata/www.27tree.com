...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d548f4d6e098_42598330',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d548f4d6e098_42598330')) {function content_52d548f4d6e098_42598330($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>全站统一评论框开发中</title>
        <meta name="description" content="全站统一评论框开发中:全站统一评论框开发中，我是标题" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="28" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">全站统一评论框开发中</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年8月17日 17:32</span>
                    </div>

                    <div class="autowarp" id="vps-content">全站统一评论框开发中，我是标题<img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0036.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
