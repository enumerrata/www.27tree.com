...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d60abebcecd3_77214909',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d60abebcecd3_77214909')) {function content_52d60abebcecd3_77214909($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>QQ登录保存头像完成</title>
        <meta name="description" content="QQ登录保存头像完成:QQ登录保存头像完成" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="17" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/37"><img src="/minbbs/default/headimg/default15.jpg"/><span id="author-nickname">_KOODO</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">QQ登录保存头像完成</h1>
                        <span id="vps-title-info">由 <a href="/user/37">_KOODO</a> 发表于 2012年8月11日 16:00</span>
                    </div>

                    <div class="autowarp" id="vps-content">QQ登录保存头像完成</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月1日 15:28 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>又换了个头像<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default15.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/37">KOODO</a> @ <a href="/user/2">koodo</a>&nbsp;：换你妹啊<span class="block Gray">2012年9月1日 22:52 / <a href="javascript:;" rel="0" actUID="37" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/2">koodo</a>&nbsp;：我的换不了啊！！<span class="block Gray">2012年9月4日 17:45 / <a href="javascript:;" rel="1" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
