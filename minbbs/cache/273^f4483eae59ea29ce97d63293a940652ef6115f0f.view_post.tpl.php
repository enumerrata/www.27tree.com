...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4fb984cca35_95673954',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4fb984cca35_95673954')) {function content_52d4fb984cca35_95673954($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>一站式 Java Web 框架 firefly-2.0_03 发布</title>
        <meta name="description" content="一站式 Java Web 框架 firefly-2.0_03 发布:
	Firefly是一个高性能一站式Web框架。涵盖了web开发的主要技术栈。包含Templateengine、IOC、MVCframework、HTTPServer、Commontools、Log、Jsonparser等模块。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="273" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">一站式 Java Web 框架 firefly-2.0_03 发布</h1>
                        <span id="vps-title-info">由 <a href="/user/201">Firing</a> 发表于 2012年12月10日 12:46</span>
                    </div>
...
<p>
	nettool<span style="line-height:1.5;">修改时间轮为静态成员</span>
</p>
<p>
	<span style="line-height:1.5;">ConcurrentLRUHashMap增加参数和listener泛型支持</span>
</p>
<p>
	<span style="line-height:1.5;">新增HTTP Server启动接口，可以通过firefly.xml配置HTTP Server的参数</span>
</p>
<p>
	<span style="line-height:1.5;">模版数组导航NPE异常问题</span>
</p>
<p>
	<span style="line-height:1.5;">解决Controller多个HTTP Method匹配问题</span><span style="line-height:1.5;"></span>
</p>
<p>
...
<p>
	...
	<p>
		下载地址：http://firefly.googlecode.com/files/firefly-2.0_03.zip<span style="line-height:1.5;"></span>
	</p>
</span>
</p></div>
                </div>
