...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52ce15abf3ad91_34869017',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ce15abf3ad91_34869017')) {function content_52ce15abf3ad91_34869017($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>停课两周</title>
        <meta name="description" content="停课两周:停课两周搞课程设计！！！爽歪歪！！！！老板你有木有！！！！！@koodo" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="95" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">停课两周</h1>
                        <span id="vps-title-info">由 <a href="/user/78">Sohol</a> 发表于 2012年9月10日 22:25</span>
                    </div>

                    <div class="autowarp" id="vps-content">停课两周搞课程设计！！！爽歪歪！！！！老板你有木有！！！！！@koodo</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月10日 22:27 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>没有啊，都要上课。<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/19">Serria</a> / 2012年9月11日 20:59 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="19">回复</a></div>真好呀！<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/19">Serria</a>&nbsp;：羡慕嫉妒恨了啊，我们还要上课。<span class="block Gray">2012年9月11日 21:20 / <a href="javascript:;" rel="0" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
