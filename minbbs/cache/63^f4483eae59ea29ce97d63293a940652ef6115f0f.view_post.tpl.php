...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5e1bdbdffd5_31000570',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5e1bdbdffd5_31000570')) {function content_52d5e1bdbdffd5_31000570($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>欢迎大家来到Java交流区</title>
        <meta name="description" content="欢迎大家来到Java交流区:有什么问题就提出来让大家讨论讨论吧！！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="63" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">欢迎大家来到Java交流区</h1>
                        <span id="vps-title-info">由 <a href="/user/78">Sohol</a> 发表于 2012年9月2日 23:13</span>
                    </div>

                    <div class="autowarp" id="vps-content">有什么问题就提出来让大家讨论讨论吧！！</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月2日 23:20 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div><p>
	什么是Java
</p><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/78_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/78">Sohol</a> @ <a href="/user/2">koodo</a>&nbsp;：百度一下谢谢老板！！<span class="block Gray">2012年9月3日 12:57 / <a href="javascript:;" rel="0" actUID="78" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/19">Serria</a> / 2012年9月4日 17:29 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="19">回复</a></div>Java什么都不懂咯。<img src="/mod/kd/plugins/emoticons/images/jx2/j_0009.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/19">Serria</a>&nbsp;：我也是<span class="block Gray">2012年9月4日 18:44 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/19">Serria</a>&nbsp;：你呀，灌水去吧，别咋这里吹水了呀。<span class="block Gray">2012年9月5日 12:11 / <a href="javascript:;" rel="1" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
