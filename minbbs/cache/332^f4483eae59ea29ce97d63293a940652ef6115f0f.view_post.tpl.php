...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5b0dc6b57b3_12352061',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5b0dc6b57b3_12352061')) {function content_52d5b0dc6b57b3_12352061($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Win8系统设置WIFI热点 </title>
        <meta name="description" content="Win8系统设置WIFI热点 :
	1、运行cmd
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="332" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Win8系统设置WIFI热点 </h1>
                        <span id="vps-title-info">由 <a href="/user/453">wangliuwei</a> 发表于 2013年4月18日 09:11</span>
                    </div>
