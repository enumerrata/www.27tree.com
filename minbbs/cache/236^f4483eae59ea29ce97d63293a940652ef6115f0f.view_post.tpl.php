...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4fdace43e50_03556421',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4fdace43e50_03556421')) {function content_52d4fdace43e50_03556421($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>找个时间学php</title>
        <meta name="description" content="找个时间学php:尼玛的学校教JSP+mssql啊，php+mysql有得啃" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="236" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">找个时间学php</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年11月14日 23:49</span>
                    </div>

                    <div class="autowarp" id="vps-content">尼玛的学校教JSP+mssql啊，php+mysql有得啃</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年11月15日 00:03 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div><p>
	jsp + mssql 太捞了吧。
</p>
<p>
	我们都是 Oracle
</p><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/2">koodo</a>&nbsp;：Oracle&amp;nbsp;数据库中的SQL是当今市场上功能最强大的SQL实现之一<span class="block Gray">2012年11月15日 00:05 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/73_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/73">_后觉</a> / 2012年11月15日 11:40 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="73">回复</a></div>一般般捞而已<img src="/mod/kd/plugins/emoticons/images/jx2/j_0020.gif" border="0" alt="" /><div class="cms"></div></div></div></div>
