...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d59a9736ab38_33014762',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d59a9736ab38_33014762')) {function content_52d59a9736ab38_33014762($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>计算utf8字符集中英混合，字符串长度</title>
        <meta name="description" content="计算utf8字符集中英混合，字符串长度:
	PHP对中文字符串的处理一直困扰于刚刚接触PHP开发的新手程序员。下面简要的剖析一下PHP对中文字符串长度的处理：


	PHP自带的函数如strlen()、mb_strlen()都是通过计算字符串所占字节数来统计字符串长度的，一个英文" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="279" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">计算utf8字符集中英混合，字符串长度</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年12月15日 15:38</span>
                    </div>
