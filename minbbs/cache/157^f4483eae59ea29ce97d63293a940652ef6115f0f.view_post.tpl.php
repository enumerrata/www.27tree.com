...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d58641335b43_04947466',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d58641335b43_04947466')) {function content_52d58641335b43_04947466($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Firefox下的浏览器兼容性检测工具:Compatibility Detector</title>
        <meta name="description" content="Firefox下的浏览器兼容性检测工具:Compatibility Detector:
	这里给大家推荐一个Firefox下的浏览器兼容性检测工具——CompatibilityDetector。这个工具对于新手来说是非常不错的一个东东，下面我就简单说下它的优点。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="157" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Firefox下的浏览器兼容性检测工具:Compatibility Detector</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年10月17日 19:55</span>
                    </div>
...
<p style="text-align:center;">
	<img src="http://litanwei-wordpress.stor.sinaapp.com/uploads/2012/02/1.png" alt="" /> 
</p>
<p>
	<br />
</p>
...
<p style="text-align:center;">
	<img src="http://litanwei-wordpress.stor.sinaapp.com/uploads/2012/02/2.png" alt="" /> 
</p>
<p style="text-align:center;">
	<img src="http://litanwei-wordpress.stor.sinaapp.com/uploads/2012/02/3.png" alt="" /> 
</p>
<p>
	如果使用高级测试功能，这个插件会把页面重新刷新一遍来获取页面中更多的兼容性问题。这当中分为“错误级别”和“警告级别”两种，警告级别中出现的问题一般不影响页面的兼容性。
</p>
<p style="text-align:center;">
	<img src="http://ued.ctrip.com/blog/wp-content/uploads/2011/10/xcompatibility3.png.pagespeed.ic.JNhohgpQF_.png" alt="" /> 
</p>
<p style="text-align:center;">
	<img src="http://litanwei-wordpress.stor.sinaapp.com/uploads/2012/02/5.png" alt="" /> 
</p>
<p>
	<br />
</p>
