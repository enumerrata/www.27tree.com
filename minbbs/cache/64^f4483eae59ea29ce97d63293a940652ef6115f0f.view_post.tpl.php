...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52cfbb8448ab58_36695591',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52cfbb8448ab58_36695591')) {function content_52cfbb8448ab58_36695591($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>设置eclipse</title>
        <meta name="description" content="设置eclipse:R.java不能自动生成代码怎么设置eclipse？" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="64" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/91"><img src="/user/data/head-img/91_head.jpg"/><span id="author-nickname">深羡凌雨Q</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">设置eclipse</h1>
                        <span id="vps-title-info">由 <a href="/user/91">深羡凌雨Q</a> 发表于 2012年9月3日 10:59</span>
                    </div>

                    <div class="autowarp" id="vps-content">R.java不能自动生成代码怎么设置eclipse？<br&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月3日 12:31 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/tsj/t_0008.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年9月3日 12:33 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>选择工程，右键 Android Tools &gt;&gt; Fix Project Properties 这个操作有时候可以修正一些错误<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="http://qzapp.qlogo.cn/qzapp/100276764/2D0153DC320A952E33ADEB502256F031/100" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/93"></a> / 2012年9月3日 19:47 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="93">回复</a></div><img border="0" alt="" src="/mod/kd/plugins/emoticons/images/ldw/l_0003.gif" />
<p>
