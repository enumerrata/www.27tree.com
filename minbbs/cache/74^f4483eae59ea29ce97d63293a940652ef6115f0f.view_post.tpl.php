...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d54633de1564_22152240',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d54633de1564_22152240')) {function content_52d54633de1564_22152240($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>我们都爱广工大</title>
        <meta name="description" content="我们都爱广工大:好可爱的学校啊，不准以实习等一切缘由旷课，固定座位，达到三次者，杀无赦。广工大，我爱你！！！！！！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="74" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">我们都爱广工大</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月4日 20:31</span>
                    </div>

                    <div class="autowarp" id="vps-content">好可爱的学校啊，不准以实习等一切缘由旷课，固定座位，达到三次者，杀无赦。广工大，我爱你！！！！！！<img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0035.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/78_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/78">Sohol</a> / 2012年9月4日 21:16 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="78">回复</a></div>我也爱它，马克思固定了座位，擦，没得逃课！！！<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/19">Serria</a> / 2012年9月4日 21:42 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="19">回复</a></div>我们随时上课随时旷课，除非不被学生部的检查到，那你就可以逍遥自在了啊。<img src="/mod/kd/plugins/emoticons/images/jx2/j_0046.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2012年9月4日 22:02 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div>最坑爹是晚上还要自习，位置居然固定。<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/2">koodo</a>&nbsp;：我们这学期的课少多了啊。一共的可也只是3天的课啊。<span class="block Gray">2012年9月4日 22:17 / <a href="javascript:;" rel="0" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/19">Serria</a>&nbsp;：我星期三星期四下午全部没课，哈哈哈哈哈哈<span class="block Gray">2012年9月4日 23:14 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：哈哈<span class="block Gray">2012年9月5日 16:27 / <a href="javascript:;" rel="2" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/29">human</a> / 2012年9月5日 16:26 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="29">回复</a></div><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/29">human</a>&nbsp;：你有得逃课么？<span class="block Gray">2012年9月5日 18:42 / <a href="javascript:;" rel="0" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/19">Serria</a>&nbsp;：我可以逃班<span class="block Gray">2012年9月6日 09:37 / <a href="javascript:;" rel="1" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
