...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d623da90ae81_77065763',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d623da90ae81_77065763')) {function content_52d623da90ae81_77065763($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>导包</title>
        <meta name="description" content="导包:作业写到servlet，导包导不到，郁闷，顺便过来看看" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="272" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">导包</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年12月9日 16:21</span>
                    </div>

                    <div class="autowarp" id="vps-content">作业写到servlet，导包导不到，郁闷，顺便过来看看<img src="/mod/kd/attached/image/20121209/20121209162107_47598.jpg" alt="" /></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年12月9日 17:37 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>gb2312?<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/73_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/73">%E5%90%8E%E8%A7%89%E3%82%9B</a> @ <a href="/user/2">koodo</a>&nbsp;：重点不在这里
<span class="block Gray">2012年12月9日 18:43 / <a href="javascript:;" rel="0" actUID="73" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/73">后觉゛</a>&nbsp;：鼠标放错误那里，看看显示什么鸡场就知道啦&amp;nbsp;<span class="block Gray">2012年12月9日 19:43 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
