...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5449c3f3c35_02725069',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5449c3f3c35_02725069')) {function content_52d5449c3f3c35_02725069($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>想问个JS内存泄漏的问题</title>
        <meta name="description" content="想问个JS内存泄漏的问题:
	看过很多的参考
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="239" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/237"><img src="/img/tavatar.gif"/><span id="author-nickname">nenge</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">想问个JS内存泄漏的问题</h1>
                        <span id="vps-title-info">由 <a href="/user/237">nenge</a> 发表于 2012年11月15日 14:06</span>
                    </div>
...
<pre id="prettyprint" class="javascript" name="code">function test(s){
function a(s){
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default7.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/201">Firing</a> / 2012年11月15日 15:52 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="201">回复</a></div>好复杂的闭包啊。。。待会试试看<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default7.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/201">Firing</a> / 2012年11月15日 15:59 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="201">回复</a></div>我记得value = null 并没有马上进行垃圾回收 ， 只是便于垃圾回收。<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2012年11月15日 16:08 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div><p>
	代码修改后 ： 
</p>
<p>
	<p>
...
<p>
	如果把aaa = new a(s); 和 aaa = null 注释掉的话。就会出现 Uncaught ReferenceError: aaa is not defined 即未定义
</p>
<p>
	如果aaa被回收了应该出现aaa is not defined这个错误 ， 所以 aaa=null并没有马上被回收。
