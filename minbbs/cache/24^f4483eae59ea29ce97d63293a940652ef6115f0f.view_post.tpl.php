...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d504723da386_47136406',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d504723da386_47136406')) {function content_52d504723da386_47136406($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>不是手机的错，手机连不上wifi，正在获取ip地址怎么办</title>
        <meta name="description" content="不是手机的错，手机连不上wifi，正在获取ip地址怎么办:
	打开设置-无线和网路-WLAN设置，按menu键，


	进入高级选项设置，在ip设置中勾选"使用静态IP"。


	为什么要选择静态IP?,因为动态IP是有租期的，路由器一般默认的租期都很短，也可以自己把租期调到最大继续使用动态地址。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="24" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">不是手机的错，手机连不上wifi，正在获取ip地址怎么办</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年8月16日 14:58</span>
                    </div>
...
<p>
	<strong>为什么要选择静态IP?,因为动态IP是有租期的，路由器一般默认的租期都很短，也可以自己把租期调到最大继续使用动态地址。</strong>&nbsp;
</p>
<p>
	<strong>但是动态地址一旦过期你是无法再连接的了。</strong>&nbsp;
</p>
<p>
	然后在"IP地址"中填入"192.168.1.X"，一般家庭使用无线路由，
</p>
<p>
	网段是192.168.1.2--192.168.1.255，X值代表的范畴是2-255之间的。
</p>
<p>
	然后再"网关"中填入192.168.1.1，或者是192.168.0.1，
</p>
<p>
	<strong>192.168.x.1里面的x一般路由器默认是1或者0，也可以自己修改，路由器桥接才需要修改。</strong>&nbsp;
</p>
<p>
	"网络掩码"&nbsp;(也叫子网掩码)&nbsp;中填入255.255.255.0，在"域名1"中填入192.168.1.1，"域名2"中填入192.168.1.1。
</p>
<p>
	DNS也称为域名系统，我们使用谷歌的DNS服务就行了&nbsp;8.8.8.8
</p>
<p>
	填一个也能够，填两个也是可以的。最后按menu键保存，这样就设置好了。
</p>
<p>
	要是还不行，请在下面发帖，我们为你解决。
</p></div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/81_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/81">quainllk</a> / 2012年8月28日 19:27 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="81">回复</a></div>也可以通过刷固件的方式来解决吧，或者重刷boot。<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年8月30日 18:52 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>从刷固件代价肯定是最高了的<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2012年9月23日 16:17 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div><p>
	先root权限
</p>
<p>
	获得权限后用RE管理器进入 data/misc/dhcp 把里面的文件删除掉就行了
</p>
<p>
	这样貌似也可以解决，有兴趣可以试试。
