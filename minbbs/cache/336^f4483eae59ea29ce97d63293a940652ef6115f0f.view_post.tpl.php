...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d501fc070419_94872367',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d501fc070419_94872367')) {function content_52d501fc070419_94872367($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Gnome 禁用 IBus 输入法白名单</title>
        <meta name="description" content="Gnome 禁用 IBus 输入法白名单:
	Gnome3.6集成了Ibus，原本是件好事。但搞Gnome的鬼佬们不懂我们中文输入法的博大精深，弄了个输入法白名单，输入源（InputSources）里只显示在白名单的输入法。而许多优秀的输入法如rime（中州韻），sunpinyin" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="336" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/3"><img src="/user/data/head-img/3_head.jpg"/><span id="author-nickname">caodan</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Gnome 禁用 IBus 输入法白名单</h1>
                        <span id="vps-title-info">由 <a href="/user/3">caodan</a> 发表于 2013年4月21日 16:57</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p style="text-indent:2em;">
	<span style="font-size:16px;">Gnome3.6集成了Ibus，原本是件好事。但搞Gnome的鬼佬们不懂我们中文输入法的博大精深，弄了个输入法白名单，输入源（Input Sources）里只显示在白名单的输入法。而许多优秀的输入法如rime（中州韻），sunpinyin，等，就不能使用。</span> 
</p>
<p style="text-indent:2em;">
	<span style="text-indent:2em;line-height:1.5;font-size:16px;">还好在&nbsp;Weng Xuetian 和 Mike Qin 的强烈要求下（详细经过:https://bugzilla.gnome.org/show_bug.cgi?id=689001），Gnome的开发者终于妥协了，留下一句：</span> 
</p>
<p style="text-indent:2em;">
	<br />
</p>
...
<pre name="code" id="prettyprint" class="bsh">gsettings set org.gnome.desktop.input-sources show-all-sources true</pre>
<p>
	<br />
</p>
<p>
...
<span style="font-size:16px;">&nbsp;</span><span style="font-size:16px;">&nbsp;</span><span style="font-size:16px;">&nbsp; &nbsp; 运行就可以在输入源（Input Sources）显示所</span><span style="font-size:16px;">有输入法了。</span> 
<p>
	<br />
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2013年4月21日 20:56 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>华哥我不懂，求魔兽文章<div class="cms"></div></div></div></div>
