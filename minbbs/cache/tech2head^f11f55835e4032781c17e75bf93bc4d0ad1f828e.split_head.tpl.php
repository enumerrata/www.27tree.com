...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d625db434a88_13898056',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d625db434a88_13898056')) {function content_52d625db434a88_13898056($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>技术分享 - 二叉树IT技术社区</title>
...
<![endif]-->
        <input id="cache_id" value="dGVjaDJoZWFk" type="hidden" />
        <div class="sdCenter" style="margin-top:55px;">
            <div style="position:absolute;top:-41px;z-index:1;left:0;right:0;height:50px;">
                <a class="ps-tab-btn " href="/minbbs/ques/">技术问答</a>
                <a class="ps-tab-btn ps-tab-btn-cur" href="/minbbs/tech/">技术分享</a>
            </div><?php }} ?>