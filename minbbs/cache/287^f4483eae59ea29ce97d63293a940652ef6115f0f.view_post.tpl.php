...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d594b0d4ac08_97923339',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d594b0d4ac08_97923339')) {function content_52d594b0d4ac08_97923339($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>下载文件的下载次数回填</title>
        <meta name="description" content="下载文件的下载次数回填:
	我们在下载软件时，经常会看到此软件的下载统计次数，而这些统计数给网站管理员分析软件的受欢迎程度带来了方便。其实现原理是：下载链接并不是直接连在文件上而是链接到一个脚本，由这个脚本对数据库中存放软件的记录进行修改，将下载数字段+1，然后再" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="287" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">下载文件的下载次数回填</h1>
                        <span id="vps-title-info">由 <a href="/user/201">Firing</a> 发表于 2012年12月18日 22:18</span>
                    </div>
