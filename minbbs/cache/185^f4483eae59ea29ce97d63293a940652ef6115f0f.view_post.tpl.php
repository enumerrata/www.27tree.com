...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d60cb413cc62_46901366',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d60cb413cc62_46901366')) {function content_52d60cb413cc62_46901366($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>VC9 VC6 Thread Safe Non Thread Safe 是什么意思？</title>
        <meta name="description" content="VC9 VC6 Thread Safe Non Thread Safe 是什么意思？:VC6版本是使用VisualStudio6编译器编译的，如果你的PHP是用Apache&nbsp;
&nbsp;&nbsp;来架设的，那你就选择VC6版本。
&nbsp;&nbsp;VC9版本是使用VisualStudio2008编译器编译" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="185" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">VC9 VC6 Thread Safe Non Thread Safe 是什么意思？</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年10月27日 12:09</span>
                    </div>

                    <div class="autowarp" id="vps-content"><span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">VC6 版本是使用 Visual Studio 6 编译器编译的，如果你的 PHP 是用 Apache&nbsp;</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 来架设的，那你就选择 VC6 版本。</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; VC9 版本是使用 Visual Studio 2008 编译器编译的，如果你的 PHP 是用 IIS&nbsp;</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 来架设的，那你就选择 VC9 版本。</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; PHP 的两种执行方式：ISAPI 和 FastCGI。</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; ISAPI 执行方式是以 DLL 动态库的形式使用，可以在被用户请求后执行，在处</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 理完一个用户请求后不会马上消失，所以需要进行线程安全检查，这样来提高</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 程序的执行效率，所以如果是以 ISAPI 来执行 PHP，建议选择 Thread Safe 版本；</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 而 FastCGI 执行方式是以单一线程来执行操作，所以不需要进行线程的安全检查，</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 除去线程安全检查的防护反而可以提高执行效率，所以，如果是以 FastCGI 来执行 PHP，</span><br style="margin:0px;padding:0px;color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;" />
<span style="color:#111111;font-family:'Microsoft YaHei', Tahoma, Arial;line-height:20.399999618530273px;background-color:#FFFFFF;">&nbsp;&nbsp; 建议选择 Non Thread Safe 版本</span></div>
                </div>
