...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d6172c422fd9_58765151',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d6172c422fd9_58765151')) {function content_52d6172c422fd9_58765151($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>奇虎旗下360旅游度假网站正式上线</title>
        <meta name="description" content="奇虎旗下360旅游度假网站正式上线:
	


	
		今天早上，奇虎旗下360旅游度假网站正式上线，打出口号“做自己的导游，平台使用二级域名go.360.cn。目前360旅游平台包括：国内景点、国际景点、旅游网址等。
	
	
		据悉，360旅游度假平台的模式类似“去哪儿网”" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="218" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/218"><img src="/minbbs/default/headimg/default27.jpg"/><span id="author-nickname">AVGSecure</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">奇虎旗下360旅游度假网站正式上线</h1>
                        <span id="vps-title-info">由 <a href="/user/218">AVGSecure</a> 发表于 2012年11月9日 08:21</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p style="text-align:center;">
	<img src="http://upload.chinaz.com/2012/1108/1352340908434.jpg" alt="" />
</p>
<p>
	<p>
		今天早上，奇虎旗下360旅游度假网站正式上线，打出口号“做自己的导游，平台使用二级域名go.360.cn。目前360旅游平台包括：国内景点、国际景点、旅游网址等。
	...
	<p>
		据悉，360旅游度假平台的模式类似“去哪儿网”，主要以展示线路为主，旅游公司可以将线路投放在该平台，按照点击效果向奇虎支付费用。
	</p>
	<p>
		刚刚进军搜索领域的360，又踏入了另一领域——旅游度假类网站。此前，奇虎360已在其导航页面中专门开辟旅游频道，接入去哪儿、携程等主流的旅游服务提供商。360进入旅游板块能否撼动携程、去哪儿网的霸主地位。
	</p>
</p></div>
                </div>
