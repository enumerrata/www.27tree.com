...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d3cd7e1850a8_52742230',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d3cd7e1850a8_52742230')) {function content_52d3cd7e1850a8_52742230($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>一个 SQL 同时验证帐号是否存在、密码是否正确</title>
        <meta name="description" content="一个 SQL 同时验证帐号是否存在、密码是否正确:
	近日偶尔看到一个很巧妙的SQL技巧，一个简单的SQL同时验证帐号是否存在、密码是否正确。之前从未曾想过这么做，也未曾见过别人这么做。虽是奇技淫巧，却真正所谓构思巧妙。如果用来面试考考别人，真的能够难倒一大片兄弟。好东西不敢独享，特公开与" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="282" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">一个 SQL 同时验证帐号是否存在、密码是否正确</h1>
                        <span id="vps-title-info">由 <a href="/user/276">我是机器人</a> 发表于 2012年12月16日 23:04</span>
                    </div>
