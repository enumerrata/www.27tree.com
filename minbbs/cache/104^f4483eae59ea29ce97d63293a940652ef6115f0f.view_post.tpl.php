...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d542cc066e67_60900654',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d542cc066e67_60900654')) {function content_52d542cc066e67_60900654($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>MySQL中，一对一的多重映射关系</title>
        <meta name="description" content="MySQL中，一对一的多重映射关系:
	现在有两个字段uid,target为int类型。


	抽象为朋友关系，uid为1与target为2建立关系，那么uid为2与target为1建立关系就是重复了。


	如何避免重复?


	uid,target均为非主键，如何避免重复" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="104" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">MySQL中，一对一的多重映射关系</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月13日 16:59</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="http://qzapp.qlogo.cn/qzapp/100276764/E7223496C6A6A7990AA82D5EBCA6402B/100" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/94">_inner peace</a> / 2012年9月13日 18:32 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="94">回复</a></div>mySQL一点不会！<div class="cms"></div></div></div></div>
