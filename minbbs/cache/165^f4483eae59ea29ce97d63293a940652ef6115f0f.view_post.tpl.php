...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61a815c0508_89217639',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61a815c0508_89217639')) {function content_52d61a815c0508_89217639($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title> 水水更健康</title>
        <meta name="description" content=" 水水更健康:才哥坑爹&nbsp;&nbsp;水水更健康" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="165" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/31"><img src="/minbbs/default/headimg/default4.jpg"/><span id="author-nickname">不是打酱油的路人甲</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title"> 水水更健康</h1>
                        <span id="vps-title-info">由 <a href="/user/31">不是打酱油的路人甲</a> 发表于 2012年10月18日 22:13</span>
                    </div>

                    <div class="autowarp" id="vps-content">才哥坑爹<img src="/mod/kd/plugins/emoticons/images/jx2/j_0020.gif" border="0" alt="" />&nbsp; &nbsp;水水更健康</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/73_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/73">_后觉</a> / 2012年10月18日 23:11 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="73">回复</a></div>打酱油的。。。。<img src="/mod/kd/plugins/emoticons/images/jx2/j_0010.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年10月18日 23:44 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>路人甲<div class="cms"></div></div></div></div>
