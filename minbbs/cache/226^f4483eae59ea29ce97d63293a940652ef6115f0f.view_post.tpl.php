...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d383a1ee5968_01856834',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d383a1ee5968_01856834')) {function content_52d383a1ee5968_01856834($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Ubuntu将从用户电脑移除Java</title>
        <meta name="description" content="Ubuntu将从用户电脑移除Java:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="226" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Ubuntu将从用户电脑移除Java</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年11月12日 23:37</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p style="text-indent:2em;">
	<span style="font-size:14px;">Sun在2006年推出了Java操作系统发行版许可证，允许Linux发行版发行Java软件包。在甲骨文收购Sun接管Java之后，甲骨文决定撤销发行许可证，这意味着Linux发行版如Ubuntu将无权在操作系统中捆绑Java包。</span>
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;">Ubuntu的开发商Canonical将从软件仓库内移除Sun Java JDK，并从用户机器上卸载Java程序。安装了sun-java-6的用户将在未来的软件更新中看到卸载提示，用户可以选择甲骨文Java</span>
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;">JDK的开源替代OpenJDK。受到影响的操作系统版本为10.04 LTs、 Ubuntu 10.10和11.04。</span>
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年11月14日 15:02 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>我这个12.04好像没影响，内置了。<div class="cms"></div></div></div></div>
