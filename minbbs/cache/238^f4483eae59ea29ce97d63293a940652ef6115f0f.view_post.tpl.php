...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5018dd9dae3_78999089',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5018dd9dae3_78999089')) {function content_52d5018dd9dae3_78999089($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>会员默认头像好像更新了哦，换了几个超人头像</title>
        <meta name="description" content="会员默认头像好像更新了哦，换了几个超人头像:你看看我的就知道啦，还有几个cs的头像" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="238" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">会员默认头像好像更新了哦，换了几个超人头像</h1>
                        <span id="vps-title-info">由 <a href="/user/201">Firing</a> 发表于 2012年11月15日 12:33</span>
                    </div>

                    <div class="autowarp" id="vps-content">你看看我的就知道啦，还有几个cs的头像</div>
                </div>
