...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4e7c7885ec5_79664645',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4e7c7885ec5_79664645')) {function content_52d4e7c7885ec5_79664645($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>今天没有新贴</title>
        <meta name="description" content="今天没有新贴:大家都忙着去迎接新生了吗？" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="86" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">今天没有新贴</h1>
                        <span id="vps-title-info">由 <a href="/user/19">Serria</a> 发表于 2012年9月6日 15:08</span>
                    </div>

                    <div class="autowarp" id="vps-content">大家都忙着去迎接新生了吗？<img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0015.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月6日 15:47 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>要把重心放在内容建设方面了。<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/2">koodo</a>&nbsp;：努力，加油吧。<span class="block Gray">2012年9月6日 20:03 / <a href="javascript:;" rel="0" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
