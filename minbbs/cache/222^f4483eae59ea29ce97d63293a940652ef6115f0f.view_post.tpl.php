...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4fad87915d1_92859995',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4fad87915d1_92859995')) {function content_52d4fad87915d1_92859995($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title> 修改.htaccess文件 将HTML文件当PHP文件使用</title>
        <meta name="description" content=" 修改.htaccess文件 将HTML文件当PHP文件使用:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="222" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title"> 修改.htaccess文件 将HTML文件当PHP文件使用</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年11月10日 21:25</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default7.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/201">Firing</a> / 2012年11月11日 11:16 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="201">回复</a></div>虚拟空间好像不支持，刚刚试过了。本地就可以<div class="cms"></div></div></div></div>
