...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d59b87553155_19652916',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d59b87553155_19652916')) {function content_52d59b87553155_19652916($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>百度真恶心</title>
        <meta name="description" content="百度真恶心:每次搜索亿柿网，他就出个易视网挡在前面。超级猥琐。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="75" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">百度真恶心</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月4日 23:18</span>
                    </div>

                    <div class="autowarp" id="vps-content">每次搜索亿柿网，他就出个易视网挡在前面。超级猥琐。</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/19">Serria</a> / 2012年9月5日 09:29 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="19">回复</a></div>就是呀？怎么这样的呢？<img src="/mod/kd/plugins/emoticons/images/jx2/j_0035.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/29">human</a> / 2012年9月5日 10:11 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="29">回复</a></div>别人给钱了。<img src="/mod/kd/plugins/emoticons/images/tsj/t_0022.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/19">Serria</a> / 2012年9月5日 12:10 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="19">回复</a></div>人家优化的好咯。有钱人家就是这样的啊。<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/2">koodo</a> / 2012年9月5日 12:37 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="2">回复</a></div>同音都欺负，坑爹的<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/66_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/66">%E5%BD%B1%E5%AD%90</a> @ <a href="/user/2">koodo</a>&nbsp;：强烈抵制这种行为<span class="block Gray">2012年9月6日 19:36 / <a href="javascript:;" rel="0" actUID="66" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
