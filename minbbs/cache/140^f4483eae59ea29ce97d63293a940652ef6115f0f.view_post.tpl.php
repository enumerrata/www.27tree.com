...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61cb9ba9796_28074577',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61cb9ba9796_28074577')) {function content_52d61cb9ba9796_28074577($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>偷菜</title>
        <meta name="description" content="偷菜:搞一个亿柿农场吧，每天来偷菜" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="140" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">偷菜</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年10月9日 19:44</span>
                    </div>

                    <div class="autowarp" id="vps-content">搞一个亿柿农场吧，每天来偷菜<img src="/mod/kd/plugins/emoticons/images/jx2/j_0005.gif" border="0" alt="" /></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年10月9日 19:55 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>上次搞那个偷几天就不玩了，操。不干<div class="cms"></div></div></div></div>
