...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d50a8f38c844_67395089',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d50a8f38c844_67395089')) {function content_52d50a8f38c844_67395089($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>vim配置文件中最常用的6个配置命令</title>
        <meta name="description" content="vim配置文件中最常用的6个配置命令:
	无事，写一个极简的vim配置档供大家参考，仅包含最常用的6个配置命令。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="269" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">vim配置文件中最常用的6个配置命令</h1>
                        <span id="vps-title-info">由 <a href="/user/66">影子</a> 发表于 2012年12月7日 23:39</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	无事，写一个极简的 vim 配置档供大家参考，仅包含最常用的6个配置命令。
</p>
<p>
	<br />
</p>
...
<pre name="code" id="prettyprint" class="">  set number
...
<p>
	这6条配置命令可以说是 vim 编辑器配置档中最常被使用到的，基本上可以满足大部分使用者的需求。
</p>
<p>
	各条命令的意思分别是：
</p>
...
<pre name="code" id="prettyprint" class=""> &nbsp;set number                //自动输入行号
  ...
  set hlsearch             //搜索到的字符串进行特别标识

  set smartindent       &nbsp; &nbsp;//自动缩进</pre>
没有把注释放置到供大家使用的文件（&lt;&nbsp; 文件一 &gt;）中是因为有少部分版本的 vim 编辑器若没有进行设置，将不能正常识别中文字符，启动编辑器时会输出“无法识别”等信息。
<p>
	<br />
</p>
<p>
...
<p>
	"~"表示当前帐号的家目录，例如：/home/test/
</p>
<p>
	"/"后有一点“.”，表示该文件为隐藏文件
</p>
<p>
	"rc"为"run command"的缩写
</p>
<p>
	<br />
</p>
...
<p>
	无论是输入编辑命令，又或者是键入配置信息（建议直接复制&lt; 文件一&gt;），需确认输入的都是英文字符。
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/66_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/66">影子</a> / 2012年12月7日 23:45 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="66">回复</a></div>沙发自己坐<img src="/mod/kd/plugins/emoticons/images/jx2/j_0005.gif" alt="" border="0" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年12月8日 11:14 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div><p>
	没用过，不懂
</p><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/img/tavatar.gif" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/268">JJyyBB</a> / 2012年12月9日 09:10 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="268">回复</a></div>配置vim吧<div class="cms"></div></div></div></div>
