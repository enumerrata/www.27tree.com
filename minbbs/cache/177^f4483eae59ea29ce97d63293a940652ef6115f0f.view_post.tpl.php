...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5c80b1fe996_85871283',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5c80b1fe996_85871283')) {function content_52d5c80b1fe996_85871283($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>mysql 批量删除表的脚本 你懂的</title>
        <meta name="description" content="mysql 批量删除表的脚本 你懂的:&lt;?php
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="177" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">mysql 批量删除表的脚本 你懂的</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2012年10月24日 22:23</span>
                    </div>

                    <div class="autowarp" id="vps-content"><pre name="code" id="prettyprint" class="PHP">&lt;?php
$hostname = 'localhost:3306';
$userid = 'root'; //数据库用户名  
$password = ''; //登录密码  
$dbname = 'itsrcs'; //数据库名称  
...
?&gt;  
&lt;p&gt;&lt;a href="javascript:history.back();" mce_href="javascript:history.back();"&gt;返回!&lt;/a&gt;</pre></div>
                </div>
