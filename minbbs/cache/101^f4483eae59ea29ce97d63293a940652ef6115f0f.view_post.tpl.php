...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d503b2447ce8_35607950',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d503b2447ce8_35607950')) {function content_52d503b2447ce8_35607950($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>这猛男不要命了</title>
        <meta name="description" content="这猛男不要命了:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="101" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">这猛男不要命了</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月12日 17:05</span>
                    </div>

                    <div class="autowarp" id="vps-content"><div&nbsp;style="text-align:center;">
	<embed&nbsp;src="http://static.video.qq.com/TPout.swf?vid=r0011arvut6&auto=1"&nbsp;type="application/x-shockwave-flash"&nbsp;width="550"&nbsp;height="400"&nbsp;quality="high"&nbsp;/>
</div></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default0.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/58">outfi</a> / 2012年9月13日 11:48 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="58">回复</a></div>捞到！！！！<div class="cms"></div></div></div></div>
