...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d5037280e936_52539699',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d5037280e936_52539699')) {function content_52d5037280e936_52539699($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>溜溜看</title>
        <meta name="description" content="溜溜看:貌似没有可以上传资料分享资料的功能" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="47" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">溜溜看</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年8月23日 19:56</span>
                    </div>

                    <div class="autowarp" id="vps-content">貌似没有可以上传资料分享资料的功能<img&nbsp;src="/mod/kd/attached/image/20120823/20120823195550_74075.jpg"&nbsp;alt=""&nbsp;/><br&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年8月23日 22:57 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>有的啊<div class="cms"></div></div></div></div>
