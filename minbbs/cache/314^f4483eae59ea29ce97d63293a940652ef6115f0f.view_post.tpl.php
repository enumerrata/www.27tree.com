...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d58cafdf41d6_94425787',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d58cafdf41d6_94425787')) {function content_52d58cafdf41d6_94425787($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>获取鼠标坐标的兼容性写法</title>
        <meta name="description" content="获取鼠标坐标的兼容性写法:
	用javascript获取当页面上鼠标（光标）位置在许多情况下都会用到，比如拖放，悬停提示（tooltip）等等。当然，这里我们依然要面对浏览器的兼容问题，在不同的浏览器下，对这些相关的属性处理方式也不同，本文详细介绍了浏览器在处理这些" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="314" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/22"><img src="/user/data/head-img/22_head.jpg"/><span id="author-nickname">malloc</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">获取鼠标坐标的兼容性写法</h1>
                        <span id="vps-title-info">由 <a href="/user/22">malloc</a> 发表于 2013年2月16日 15:59</span>
                    </div>
