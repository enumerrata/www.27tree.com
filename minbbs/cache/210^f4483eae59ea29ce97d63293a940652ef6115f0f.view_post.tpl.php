<?php /*%%SmartyHeaderCode:15689476765169e6f77c2fc9-73508221%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '15689476765169e6f77c2fc9-73508221',
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_518251749b84d0_11879636',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_518251749b84d0_11879636')) {function content_518251749b84d0_11879636($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="210" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/"><img src="http://itsrcs.b0.upaiyun.com/img/tavatar.gif"/><span id="author-nickname"></span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title"></h1>
                        <span id="vps-title-info">由 <a href="/user/"></a> 发表于 1970年1月1日 08:00</span>
                    </div>

                    <div class="autowarp" id="vps-content"></div>
                </div>
