...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d6272f7b8cd5_85980494',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d6272f7b8cd5_85980494')) {function content_52d6272f7b8cd5_85980494($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>编程已死 码农永生</title>
        <meta name="description" content="编程已死 码农永生:编程已死&nbsp;码农永生" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="60" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">编程已死 码农永生</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年8月31日 18:17</span>
                    </div>

                    <div class="autowarp" id="vps-content"><a&nbsp;href="http://www.itsrcs.com/blog/2012-08-31/content_126.html"&nbsp;target="_blank">编程已死&nbsp;码农永生</a></div>
                </div>
