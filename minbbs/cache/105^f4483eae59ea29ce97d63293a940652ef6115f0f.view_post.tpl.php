...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d50a5b4738c1_11266772',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d50a5b4738c1_11266772')) {function content_52d50a5b4738c1_11266772($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>怎么解决啊？</title>
        <meta name="description" content="怎么解决啊？:
	&lt;p&gt;用户定义聚合函数&nbsp;6218错误&nbsp;未通过身份验证&lt;/p&gt;


	&lt;&nbsp;p&gt;在SQL&nbsp;Server中部署程序集时，如果报以下错误，原因很简单。如果是用VS201" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="105" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/94"><img src="http://qzapp.qlogo.cn/qzapp/100276764/E7223496C6A6A7990AA82D5EBCA6402B/100"/><span id="author-nickname">_inner peace</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">怎么解决啊？</h1>
                        <span id="vps-title-info">由 <a href="/user/94">_inner peace</a> 发表于 2012年9月14日 21:22</span>
                    </div>
...
<p>
	&lt;&nbsp;p&gt;在SQL&nbsp;Server中部署程序集时，如果报以下错误，原因很简单。如果是用VS2010创建并编译的就报以下错，只需用VS2008创建程序和编译问题即不存在。&lt;/p&gt;
</p>
<p>
	&lt;&nbsp;p&gt;&ldquo;消息&nbsp;6218，级别&nbsp;16，状态&nbsp;3，第&nbsp;1&nbsp;行&lt;br&nbsp;/&gt;针对程序集&nbsp;&nbsp;UDAs&nbsp;&nbsp;的&nbsp;CREATE&nbsp;ASSEMBLY&nbsp;失败，原因是程序集&nbsp;&nbsp;UDAs&nbsp;&nbsp;未通过身份验证。请检查被引用程序集是否是最新的，而且是可信的(external_access&nbsp;或&nbsp;unsafe)，能在该数据库中执行。
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月14日 21:35 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>mysql与mssql。鸡和鸭讲眼咯咯。<div class="cms"></div></div></div></div>
