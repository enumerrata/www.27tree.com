...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d504ccce0027_69627289',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d504ccce0027_69627289')) {function content_52d504ccce0027_69627289($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>来灌灌水</title>
        <meta name="description" content="来灌灌水:有什么好电影大家介绍介绍哇！！！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="315" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">来灌灌水</h1>
                        <span id="vps-title-info">由 <a href="/user/78">Sohol</a> 发表于 2013年2月19日 23:19</span>
                    </div>

                    <div class="autowarp" id="vps-content">有什么好电影大家介绍介绍哇！！！</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2013年2月19日 23:21 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>一路向西<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/78_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/78">Sohol</a> @ <a href="/user/2">koodo</a>&nbsp;：没意思<span class="block Gray">2013年2月19日 23:26 / <a href="javascript:;" rel="0" actUID="78" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/355_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/355">dede你妹的</a> / 2013年2月21日 16:01 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="355">回复</a></div>一路向南<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/341_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/341">baby</a> / 2013年2月22日 10:49 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="341">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0036.gif" border="0" alt="" />一路向西?<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/19">Serria</a> / 2013年2月27日 09:15 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="19">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0025.gif" border="0" alt="" /><div class="cms"></div></div></div></div>
