...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4ae0582a2f3_50050847',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4ae0582a2f3_50050847')) {function content_52d4ae0582a2f3_50050847($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>爆笑盘点：车祸不死哥排行榜!</title>
        <meta name="description" content="爆笑盘点：车祸不死哥排行榜!:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="300" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">爆笑盘点：车祸不死哥排行榜!</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年12月27日 11:32</span>
                    </div>

                    <div class="autowarp" id="vps-content"><div style="text-align:center;">
	<embed src="http://player.youku.com/player.php/sid/XMzUzMTc3NjQ4/v.swf" type="application/x-shockwave-flash" width="610" height="500" quality="high" />
</div></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年12月29日 12:20 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>最牛体操哥<div class="cms"></div></div></div></div>
