...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d54833d1a3b8_98447325',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d54833d1a3b8_98447325')) {function content_52d54833d1a3b8_98447325($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>去掉 codeigniter URL 中的 index.php</title>
        <meta name="description" content="去掉 codeigniter URL 中的 index.php:
	在CI根目录（与index.php同级）下新建立一个配置文件，命名为：.htaccess
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="280" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">去掉 codeigniter URL 中的 index.php</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年12月16日 12:23</span>
                    </div>
