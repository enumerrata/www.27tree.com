...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d60ac37ad3a6_42107986',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d60ac37ad3a6_42107986')) {function content_52d60ac37ad3a6_42107986($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="34" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/71"><img src="/img/tavatar.gif"/><span id="author-nickname">like888888</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">求书</h1>
                        <span id="vps-title-info">由 <a href="/user/71">like888888</a> 发表于 2012年8月20日 09:17</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/29">human</a> / 2012年8月20日 09:27 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="29">回复</a></div>你要的是电子书、还是实体书？<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/29">human</a> / 2012年8月20日 09:39 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="29">回复</a></div>有的、你要的话留下联系方式、我们传上资源就联系你吧<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2012年8月20日 17:59 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div><p>
	<a href="http://www.itsrcs.com/bookLib/88" target="_blank">http://www.itsrcs.com/bookLib/88</a>
</p>
<p>
	搞定了，去下载吧。
</p><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/66_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/66">%E5%BD%B1%E5%AD%90</a> @ <a href="/user/2">koodo</a>&nbsp;：这么好，给我来本《The&amp;nbsp;C&amp;nbsp;programming》<span class="block Gray">2012年9月6日 19:25 / <a href="javascript:;" rel="0" actUID="66" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/66">影子</a>&nbsp;：哦，我有这个书，忘记上传了。<span class="block Gray">2012年9月6日 21:02 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/66">影子</a>&nbsp;：http://www.itsrcs.com/bookLib/106<span class="block Gray">2012年9月7日 07:58 / <a href="javascript:;" rel="2" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
