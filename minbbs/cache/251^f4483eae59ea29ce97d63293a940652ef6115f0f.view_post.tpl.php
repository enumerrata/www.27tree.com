...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4fcaef1ba65_42804959',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4fcaef1ba65_42804959')) {function content_52d4fcaef1ba65_42804959($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>UNIX 的哲学</title>
        <meta name="description" content="UNIX 的哲学:
	&nbsp;&nbsp;&nbsp;UNIXlike世界里的基本准则，你能做到几个——
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="251" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">UNIX 的哲学</h1>
                        <span id="vps-title-info">由 <a href="/user/66">影子</a> 发表于 2012年11月24日 19:18</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	&nbsp;&nbsp;<span style="font-size:16px;">&nbsp; UNIX like 世界里的基本准则，你能做到几个——</span>
</p>
<ol>
	<li>
		<span style="font-size:16px;">小即是美</span>
	</li>
	<li>
		<span style="font-size:16px;">只做一件事情，然后做好它</span>
	</li>
	<li>
		<span style="font-size:16px;">可移植性第一，高效率第二</span>
	</li>
	<li>
		<span style="font-size:16px;">可以建立原型就尽快</span>
	</li>
	<li>
		<span style="font-size:16px;">使用纯文本文件来存储数据</span>
	</li>
	<li>
		<span style="font-size:16px;">充分利用程序的杠杆作用</span>
	</li>
	<li>
		<span style="font-size:16px;">使用shell脚本来提高杠杆作用和可移植性</span>
	</li>
	<li>
		<span style="font-size:16px;">每一个程序都应该成为过滤器</span>
	</li>
	<li>
		<span style="font-size:16px;">避免强制性的用户界面</span>
	</li>
</ol>
<p>
	<p>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年11月29日 21:17 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>效率第一<div class="cms"></div></div></div></div>
