...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d55c662a08b7_62290212',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d55c662a08b7_62290212')) {function content_52d55c662a08b7_62290212($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>为什么有那么多人恨 MongoDB ？</title>
        <meta name="description" content="为什么有那么多人恨 MongoDB ？:
	因为几乎所有人都把MongoDB想象成是圣杯或者是银弹。


	和其他所有的技术一样，设计MongoDB并不是为了解决所有的问题。NoSQL在这两年获得极大的关注，很多人尝试找到一个能解决所有问题的绝活儿。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="303" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/276"><img src="/user/data/head-img/276_head.jpg"/><span id="author-nickname">我是机器人</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">为什么有那么多人恨 MongoDB ？</h1>
                        <span id="vps-title-info">由 <a href="/user/276">我是机器人</a> 发表于 2013年1月5日 16:09</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	因为几乎所有人都把 MongoDB 想象成是圣杯或者是银弹。
</p>
<p>
	和其他所有的技术一样，设计 MongoDB 并不是为了解决所有的问题。NoSQL 在这两年获得极大的关注，很多人尝试找到一个能解决所有问题的绝活儿。
</p>
<p>
	我已经使用 MongoDB 一年多了，包括两个完全不同领域和需求的项目，结果还是令我满意的。但是完美吗？很显然不是，我从不觉得一项新技术是完美的，我只是觉得使用起来很舒服，在某种意义上它适用于我目前遇见的问题，就这么简单。
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/32_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/32">mallocx</a> / 2013年1月13日 00:16 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="32">回复</a></div>速度很快的啊<div class="cms"></div></div></div></div>
