...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d509b54687d9_44768629',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d509b54687d9_44768629')) {function content_52d509b54687d9_44768629($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>犀睾利</title>
        <meta name="description" content="犀睾利:亿柿什么时候变了二叉树了，×" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="316" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/382"><img src="/img/tavatar.gif"/><span id="author-nickname">Diors</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">犀睾利</h1>
                        <span id="vps-title-info">由 <a href="/user/382">Diors</a> 发表于 2013年2月28日 18:23</span>
                    </div>

                    <div class="autowarp" id="vps-content">亿柿什么时候变了二叉树了，×</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2013年2月28日 18:26 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>以前的难听啊<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：现在的叉叉声·猥琐了<span class="block Gray">2013年3月1日 14:27 / <a href="javascript:;" rel="0" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：现在的叉叉声·猥琐了<span class="block Gray">2013年3月1日 14:27 / <a href="javascript:;" rel="1" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
