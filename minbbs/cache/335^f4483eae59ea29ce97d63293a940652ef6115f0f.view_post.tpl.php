...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d547b3d9b8f7_89458912',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d547b3d9b8f7_89458912')) {function content_52d547b3d9b8f7_89458912($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>尼玛最近很多东西要做啊</title>
        <meta name="description" content="尼玛最近很多东西要做啊:动态现在已经重写了，要吐槽评论出动态，问题有人回答出动态，还有很多啊。然后文章评论了缓存没及时刷新。吐槽发了缓存又没及时刷新。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="335" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">尼玛最近很多东西要做啊</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2013年4月19日 00:11</span>
                    </div>

                    <div class="autowarp" id="vps-content">动态现在已经重写了，要吐槽评论出动态，问题有人回答出动态，还有很多啊。然后文章评论了缓存没及时刷新。吐槽发了缓存又没及时刷新。</div>
                </div>
