...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d59d142719a4_33740064',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d59d142719a4_33740064')) {function content_52d59d142719a4_33740064($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>解决VPS系统时间不能同步更新</title>
        <meta name="description" content="解决VPS系统时间不能同步更新:
	win2003系统有一个DOS命令可以实现日期时间的更新同步：W32TM/resync


	那么，这时我们设定一个计划任务，定时让它执行就可以了。


	在C盘根目录建立一个time.bat文件，文件的内容就是W32TM/resync" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="330" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">解决VPS系统时间不能同步更新</h1>
                        <span id="vps-title-info">由 <a href="/user/451">鑫盛创业❥西西</a> 发表于 2013年4月17日 16:09</span>
                    </div>
...
<p>
	然后，在控制面板添加新的计划任务，设置定期执行这个批处理文件就可以解决了。
</p></div>
                </div>
