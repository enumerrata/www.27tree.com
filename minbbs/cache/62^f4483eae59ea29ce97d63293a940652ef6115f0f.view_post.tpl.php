...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d542eddfd7f0_85555496',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d542eddfd7f0_85555496')) {function content_52d542eddfd7f0_85555496($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>老板说我不发帖灌水</title>
        <meta name="description" content="老板说我不发帖灌水:于是我就来灌灌水！！！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="62" id="postid" />

            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="/user/78"><img src="/user/data/head-img/78_head.jpg"/><span id="author-nickname">Sohol</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">老板说我不发帖灌水</h1>
                        <span id="vps-title-info">由 <a href="/user/78">Sohol</a> 发表于 2012年9月2日 23:01</span>
                    </div>

                    <div class="autowarp" id="vps-content">于是我就来灌灌水！！！<img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0019.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/><img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0019.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月2日 23:01 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>强制灌水<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/78_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/78">Sohol</a> @ <a href="/user/2">koodo</a>&nbsp;：你妹！！<span class="block Gray">2012年9月2日 23:03 / <a href="javascript:;" rel="0" actUID="78" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/29">human</a> / 2012年9月3日 11:31 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="29">回复</a></div><img src="/mod/kd/plugins/emoticons/images/tsj/t_0031.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/29">human</a>&nbsp;：ZZZZZZZZZZZ<span class="block Gray">2012年9月3日 12:53 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/19">Serria</a> / 2012年9月3日 21:07 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="19">回复</a></div><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/19">Serria</a>&nbsp;：没字？<span class="block Gray">2012年9月3日 21:10 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
