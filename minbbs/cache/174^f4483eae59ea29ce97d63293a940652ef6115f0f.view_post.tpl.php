...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d60b1f0b5688_68875945',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d60b1f0b5688_68875945')) {function content_52d60b1f0b5688_68875945($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>C JAVA Pyhon 最本质的区别 ?</title>
        <meta name="description" content="C JAVA Pyhon 最本质的区别 ?:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="174" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">C JAVA Pyhon 最本质的区别 ?</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年10月23日 12:49</span>
                    </div>

                    <div class="autowarp" id="vps-content"><div style="text-align:center;">
	<img src="/mod/kd/attached/image/20121023/20121023124907_19869.jpg" alt="" />
</div></div>
                </div>
