...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d50ae1e8d6b6_96616533',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d50ae1e8d6b6_96616533')) {function content_52d50ae1e8d6b6_96616533($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>实现MySQL随机查询数据的几个步骤</title>
        <meta name="description" content="实现MySQL随机查询数据的几个步骤:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="263" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">实现MySQL随机查询数据的几个步骤</h1>
                        <span id="vps-title-info">由 <a href="/user/201">Firing</a> 发表于 2012年12月5日 11:43</span>
                    </div>
