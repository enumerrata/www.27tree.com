...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d508b550f6f4_90050632',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d508b550f6f4_90050632')) {function content_52d508b550f6f4_90050632($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>使用crul检查超链接的有效性</title>
        <meta name="description" content="使用crul检查超链接的有效性:&lt;?php
functioncheck_remote_file_exists($url){
$curl=curl_init($url);
//不取回数据
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="296" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">使用crul检查超链接的有效性</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年12月23日 20:53</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年12月23日 20:53 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>二话不说贴代码<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年12月27日 01:14 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0015.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/2">koodo</a>&nbsp;：ts<span class="block Gray">2012年12月27日 01:14 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/img/tavatar.gif" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/348">xiaow</a> @ <a href="/user/2">koodo</a>&nbsp;：牛~~~<span class="block Gray">2013年2月22日 10:27 / <a href="javascript:;" rel="1" actUID="348" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default32.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/312"></a> / 2013年1月10日 13:05 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="312">回复</a></div><p>
	lz是写PHP + Python的吧
</p><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/312">都市浮云</a>&nbsp;：我是前后端加美工，哈哈。<span class="block Gray">2013年1月10日 16:00 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/312">都市浮云</a>&nbsp;：我是前后端加美工，哈哈。<span class="block Gray">2013年1月10日 16:00 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">4&#x697C; / <a href="/user/2">koodo</a> / 2013年1月10日 15:47 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="3" actUID="2">回复</a></div>我是写php的啦<div class="cms"></div></div></div></div>
