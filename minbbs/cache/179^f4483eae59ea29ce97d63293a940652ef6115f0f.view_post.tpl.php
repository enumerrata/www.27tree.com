...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d508323c1908_13751305',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d508323c1908_13751305')) {function content_52d508323c1908_13751305($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>解决用ntfs-3g挂载ntfs文件系统时中文乱码</title>
        <meta name="description" content="解决用ntfs-3g挂载ntfs文件系统时中文乱码:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="179" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">解决用ntfs-3g挂载ntfs文件系统时中文乱码</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2012年10月24日 23:43</span>
                    </div>
