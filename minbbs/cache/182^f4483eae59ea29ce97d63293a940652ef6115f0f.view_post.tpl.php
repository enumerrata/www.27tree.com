...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d50a0f3ceb07_71470785',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d50a0f3ceb07_71470785')) {function content_52d50a0f3ceb07_71470785($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>vi替换示例 行号 跳转至文件末尾</title>
        <meta name="description" content="vi替换示例 行号 跳转至文件末尾:
	...
	:n,$s/vivian/sky/替换第n行开始到最后一行中每一行的第一个vivian为sk" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="182" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">vi替换示例 行号 跳转至文件末尾</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2012年10月25日 08:43</span>
                    </div>
...
<p>
	打开文件后输入 ：set number 即可显示行号
</p>
<p>
	打开文件后 G可跳至文件末尾 <strong>记住是大型的G 小写g是跳至文件头部</strong>
</p></div>
                </div>
