...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d296d1d56056_25067677',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d296d1d56056_25067677')) {function content_52d296d1d56056_25067677($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	目标地址http://www.itsrcs.com/art/java/content/2012-06-19/1340075550.html
" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="234" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">what happened</h1>
                        <span id="vps-title-info">由 <a href="/user/73">_后觉</a> 发表于 2012年11月14日 21:09</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	<img src="/mod/kd/attached/image/20121114/20121114210901_24112.jpg" alt="" />
</p>
<p>
	目标地址http://www.itsrcs.com/art/java/content/2012-06-19/1340075550.html
</p></div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default7.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/201">Firing</a> / 2012年11月14日 21:30 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="201">回复</a></div>xml文件解析错误，懒得删数据库的东西<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/73_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/73">_后觉</a> / 2012年11月14日 23:50 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="73">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0012.gif" border="0" alt="" /><div class="cms"></div></div></div></div>
