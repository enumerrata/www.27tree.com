...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d3f0730e3577_52090577',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d3f0730e3577_52090577')) {function content_52d3f0730e3577_52090577($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>使用ETags减少Web应用带宽和负载</title>
        <meta name="description" content="使用ETags减少Web应用带宽和负载:
	介绍


	最近，大众对于REST风格应用架构表现出强烈兴趣，这表明Web的优雅设计开始受到人们的注意。现在，我们逐渐理解了“3W架构（ArchitectureoftheWorldWideWeb）”内在所蕴含的可伸缩性和弹性，并进一步探" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="325" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">使用ETags减少Web应用带宽和负载</h1>
                        <span id="vps-title-info">由 <a href="/user/22">malloc</a> 发表于 2013年3月31日 21:42</span>
                    </div>
