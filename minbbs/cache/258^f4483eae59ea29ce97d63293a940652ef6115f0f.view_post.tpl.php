...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d621d4766233_02927407',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d621d4766233_02927407')) {function content_52d621d4766233_02927407($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>ie a标签 应用负margin导致的bug</title>
        <meta name="description" content="ie a标签 应用负margin导致的bug:
	在对一个display:block的a标签应用负的margin值时，不知道为什么display自动变成inline了。


	为修复这个错误，添加position:relative即可，貌似出现什么错误的时候，加个relative有时能" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="258" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">ie a标签 应用负margin导致的bug</h1>
                        <span id="vps-title-info">由 <a href="/user/172">Admin</a> 发表于 2012年12月2日 19:10</span>
                    </div>
...
<p>
	为修复这个错误，添加position:relative即可，貌似出现什么错误的时候，加个relative有时能解决。
</p></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/172_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/172">Admin</a> / 2012年12月2日 19:15 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="172">回复</a></div>将父节点position:relative也可以解决这个问题<div class="cms"></div></div></div></div>
