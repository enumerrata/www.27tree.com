...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61ca1ab35d1_05482887',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61ca1ab35d1_05482887')) {function content_52d61ca1ab35d1_05482887($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>来一道概率题</title>
        <meta name="description" content="来一道概率题:&nbsp;假设发现了一颗不均匀的骰子，由于它，使得在进行掷一对骰子的试验中时，在该样本空间中出现偶数和（如（1，1），（1，3）等）的次数比奇数和（如（2，1），（2，3）等）的次数多一倍，求点数和小于6和点数、等于8的、点数和是偶数的概" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="317" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">来一道概率题</h1>
                        <span id="vps-title-info">由 <a href="/user/78">Sohol</a> 发表于 2013年3月3日 22:32</span>
                    </div>

                    <div class="autowarp" id="vps-content">&nbsp;假设发现了一颗不均匀的骰子，由于它，使得在进行掷一对骰子的试验中时，在该样本空间中出现偶数和（如（1，1），（1，3）等）的次数比奇数和（如（2，1），（2，3）等）的次数多一倍，求点数和小于6和点数、等于8的、点数和是偶数的概率。</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default30.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/389">rmsign</a> / 2013年3月3日 22:49 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="389">回复</a></div>0<div class="cms"></div></div></div></div>
