...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d20d812b28f3_97574317',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d20d812b28f3_97574317')) {function content_52d20d812b28f3_97574317($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>2012</title>
        <meta name="description" content="2012:传说中的2012就来了··你们那些非主流还不快跑！！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="199" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">2012</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年11月3日 09:26</span>
                    </div>

                    <div class="autowarp" id="vps-content">传说中的2012就来了··你们那些非主流还不快跑<img src="/mod/kd/plugins/emoticons/images/tsj/t_0033.gif" border="0" alt="" />！！</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年11月3日 10:13 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>去哪里，去火星吗<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：草·你没上Q？<span class="block Gray">2012年11月3日 10:23 / <a href="javascript:;" rel="0" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
