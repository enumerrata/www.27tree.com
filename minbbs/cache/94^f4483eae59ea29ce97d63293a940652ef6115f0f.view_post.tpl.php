...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d601ec981267_47660600',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d601ec981267_47660600')) {function content_52d601ec981267_47660600($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>《We Are the World》群星版 - 25年后新版</title>
        <meta name="description" content="《We Are the World》群星版 - 25年后新版:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="94" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">《We Are the World》群星版 - 25年后新版</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月10日 21:26</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p&nbsp;style="text-align:center;">
	<embed&nbsp;src="http://www.tudou.com/v/L2c-LvbBB-E/&resourceId=0_04_05_99/v.swf"&nbsp;type="application/x-shockwave-flash"&nbsp;width="550"&nbsp;height="400"&nbsp;quality="high"&nbsp;/>
</p>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月11日 08:30 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>celine dion的高音最给力。<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/66_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/66">影子</a> / 2012年10月5日 18:46 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="66">回复</a></div>我也喜欢着首，MJ迷<img src="/mod/kd/plugins/emoticons/images/jx2/j_0005.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/66">影子</a>&nbsp;：吹吧你<span class="block Gray">2012年10月6日 11:50 / <a href="javascript:;" rel="0" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2012年12月29日 23:50 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0035.gif" border="0" alt="" /><br /><div class="cms"></div></div></div></div>
