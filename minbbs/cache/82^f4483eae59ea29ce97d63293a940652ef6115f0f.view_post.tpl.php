...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d54240b355f5_07202017',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d54240b355f5_07202017')) {function content_52d54240b355f5_07202017($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>吃柿饼</title>
        <meta name="description" content="吃柿饼:希望柿饼积分真的有柿饼吃啊。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="82" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">吃柿饼</h1>
                        <span id="vps-title-info">由 <a href="/user/19">Serria</a> 发表于 2012年9月5日 18:45</span>
                    </div>

                    <div class="autowarp" id="vps-content">希望柿饼积分真的有柿饼吃啊。<img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0019.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月5日 18:51 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>100个换真的柿饼哈哈<img src="/mod/kd/plugins/emoticons/images/jx2/j_0022.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/19_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/19">Serria</a> @ <a href="/user/2">koodo</a>&nbsp;：好啊，那你买多几个柿饼给我啊&amp;nbsp;。<span class="block Gray">2012年9月5日 21:48 / <a href="javascript:;" rel="0" actUID="19" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/19">Serria</a>&nbsp;：没钱哦亲<span class="block Gray">2012年9月5日 22:11 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/2">koodo</a> / 2012年9月6日 06:59 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="2">回复</a></div>柿饼不好吃。。。<div class="cms"></div></div></div></div>
