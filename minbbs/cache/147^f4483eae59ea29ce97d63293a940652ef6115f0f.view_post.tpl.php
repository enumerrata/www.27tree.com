...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d3623a282b91_45634111',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d3623a282b91_45634111')) {function content_52d3623a282b91_45634111($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>bShare 自定义分享内容，标题和图片</title>
        <meta name="description" content="bShare 自定义分享内容，标题和图片:
	bShare一般会分享当前页面的链接、标题及摘要，摘要默认为Meta标签中Description部分的内容。不同的平台可能会接受不同的分享内容，比如有的社会化书签只接受链接和标题，不接受摘要。特别是对于微博类的分享平台，bShare提供" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="147" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">bShare 自定义分享内容，标题和图片</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年10月12日 01:04</span>
                    </div>
