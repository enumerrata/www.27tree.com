...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61cddc8e369_23403865',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61cddc8e369_23403865')) {function content_52d61cddc8e369_23403865($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>求组队去玩雪</title>
        <meta name="description" content="求组队去玩雪:貌似广州天河公园有人造雪的地方·求组队一起去玩" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="169" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">求组队去玩雪</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年10月22日 10:16</span>
                    </div>

                    <div class="autowarp" id="vps-content">貌似广州天河公园有人造雪的地方·求组队一起去玩</div>
                </div>
