...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52ce08cc8d4825_11672680',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ce08cc8d4825_11672680')) {function content_52ce08cc8d4825_11672680($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>FSO生成UTF-8编码文件的解决方法</title>
        <meta name="description" content="FSO生成UTF-8编码文件的解决方法:
	昨天给aw写一个生成天气预报的xml文件的程序，考虑到通用性，于是选择utf-8编码，我也比较偏好这个编码。最先想到用FSO来写这个xml文件，后来却发现生成的xml文件不能正常显示，仅仅是因为编码的原因。用记事本打开生成的xml文件，" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="334" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">FSO生成UTF-8编码文件的解决方法</h1>
                        <span id="vps-title-info">由 <a href="/user/451">鑫盛创业❥西西</a> 发表于 2013年4月18日 17:43</span>
                    </div>
