...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d506c34344c0_12718991',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d506c34344c0_12718991')) {function content_52d506c34344c0_12718991($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>老板老是催我换头像</title>
        <meta name="description" content="老板老是催我换头像:" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="91" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">老板老是催我换头像</h1>
                        <span id="vps-title-info">由 <a href="/user/78">Sohol</a> 发表于 2012年9月6日 23:56</span>
                    </div>

                    <div class="autowarp" id="vps-content"><img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0013.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/><img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0013.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/><img&nbsp;src="/mod/kd/plugins/emoticons/images/jx2/j_0013.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/><br&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月6日 23:58 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>换头像好啊，那些默认头像太sb了啊。<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default4.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/29">human</a> / 2012年9月7日 09:18 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="29">回复</a></div><img src="/mod/kd/plugins/emoticons/images/tsj/t_0033.gif" border="0" alt="" />你还是换回默认头像吧<div class="cms"></div></div></div></div>
