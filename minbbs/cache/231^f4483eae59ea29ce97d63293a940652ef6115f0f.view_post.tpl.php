...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4fdec736b75_67201919',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4fdec736b75_67201919')) {function content_52d4fdec736b75_67201919($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>发现了一个很不错的外国模板站</title>
        <meta name="description" content="发现了一个很不错的外国模板站:
	你猜我想干嘛
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="231" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">发现了一个很不错的外国模板站</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年11月13日 11:43</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/73_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/73">_后觉</a> / 2012年11月13日 11:55 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="73">回复</a></div><img src="/mod/kd/plugins/emoticons/images/jx2/j_0001.gif" border="0" alt="" /><div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/151_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/151">鸡仔食饭米</a> / 2012年12月25日 20:00 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="151">回复</a></div><img border="0" alt="" src="/mod/kd/plugins/emoticons/images/jx2/j_0004.gif" />吐槽<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x5730;&#x677F; / <a href="/user/2">koodo</a> / 2012年12月27日 01:25 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="2" actUID="2">回复</a></div>不过现在我忘记了。。。<div class="cms"></div></div></div></div>
