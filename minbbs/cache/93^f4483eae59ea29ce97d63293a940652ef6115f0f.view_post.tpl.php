...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d44d254ed788_85228530',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d44d254ed788_85228530')) {function content_52d44d254ed788_85228530($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>《We Are the World》群星版</title>
        <meta name="description" content="《We Are the World》群星版:
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="93" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">《We Are the World》群星版</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月10日 21:24</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p&nbsp;style="text-align:center;">
	<embed&nbsp;src="http://www.tudou.com/v/xnrDeOpDX7c/&resourceId=0_04_05_99/v.swf"&nbsp;type="application/x-shockwave-flash"&nbsp;width="550"&nbsp;height="400"&nbsp;quality="high"&nbsp;/>
</p>
<p>
	1984年美国群星响应联合国国际粮食年为非洲灾民义演的一首歌，中文名是“天下一家”，由<strong>迈克尔·杰克逊</strong>和<strong>莱昂内尔·里奇</strong>合作完成.
</p></div>
                </div>
