...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d623bf898b37_42363020',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d623bf898b37_42363020')) {function content_52d623bf898b37_42363020($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Javascript 区分 一个数组和普通对象</title>
        <meta name="description" content="Javascript 区分 一个数组和普通对象:
	今天本来用的typeofarr=='object'来区分对象，谁知道我一个数组传进去居然也返回了true。


	手贱google了一下，网上的答案是&nbsp;Object.prototype.toString.call(arr)!=" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="340" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Javascript 区分 一个数组和普通对象</h1>
                        <span id="vps-title-info">由 <a href="/user/32">mallocx</a> 发表于 2013年5月7日 23:14</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	今天本来用的 typeof arr == 'object' 来区分对象，谁知道我一个数组传进去居然也返回了true。
</p>
<p>
	手贱google了一下，网上的答案是&nbsp;Object.prototype.toString.call(<strong>arr</strong>) !== '[object Array]' 来区分对象。
</p>
<p>
	所以我们可以&nbsp;
</p>
<p>
	if(Object.prototype.toString.call(arr) !== '[object Array]') // 数组
</p>
<p>
	else //对象
</p></div>
