...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d4abcc497ec8_00730611',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d4abcc497ec8_00730611')) {function content_52d4abcc497ec8_00730611($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Ubuntu安装徽软雅黑字体</title>
        <meta name="description" content="Ubuntu安装徽软雅黑字体:
	Ubuntu安装徽软雅黑字体要在ubuntu12.04下安装微软雅黑字体，非常简单，通过以下几个简单步骤就可轻松搞定了。&nbsp;&nbsp;
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="339" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Ubuntu安装徽软雅黑字体</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2013年4月24日 15:38</span>
                    </div>

                    <div class="autowarp" id="vps-content"><p>
	Ubuntu安装<strong>徽软雅黑字体</strong> 要在ubuntu 12.04下安装微软雅黑字体，非常简单，通过以下几个简单步骤就可轻松搞定了。 &nbsp;&nbsp;
</p>
<p>
	&nbsp; &nbsp;&nbsp;
</p>
<p>
	1、下载http://dl.vmall.com/c0z2rqzjwf字体，或者从win7中将(windows/fonts/目录下msyh.ttf和msyhbd.ttf)拷贝。 &nbsp; &nbsp; &nbsp;&nbsp;
</p>
<p>
	2、执行命令：sudo mkdir &nbsp;/usr/share/fonts/truetype/msyahei，创建msyahei目录，并且将下载好的字体拷入其中。&nbsp;
</p>
<p>
	3、执行命令：sudo chmod 664 msyh* 更改字体权限。 &nbsp; &nbsp; &nbsp;
</p>
<p>
	4、刷新字体缓存，执行命令：sudo &nbsp;fc-cahce -fv，然后sudo reboot&nbsp;即可。
</p>
<p>
	<br />
</p>
<p>
	<img src="/mod/kd/plugins/emoticons/images/jx2/j_0037.gif" border="0" alt="" />
</p></div>
                </div>
