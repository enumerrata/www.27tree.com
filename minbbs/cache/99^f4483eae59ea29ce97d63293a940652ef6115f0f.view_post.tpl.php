...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52c8161c888dd2_16091472',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52c8161c888dd2_16091472')) {function content_52c8161c888dd2_16091472($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>哈哈  好消息</title>
        <meta name="description" content="哈哈  好消息:老板今天给我配了一部手机·哈哈" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="99" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">哈哈  好消息</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年9月12日 13:45</span>
                    </div>

                    <div class="autowarp" id="vps-content">老板今天给我配了一部手机·哈哈<img&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0020.gif"&nbsp;border="0"&nbsp;alt=""&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/minbbs/default/headimg/default15.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/37">_KOODO</a> / 2012年9月12日 15:08 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="37">回复</a></div>什么机啊<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/37">KOODO</a>&nbsp;：你猜猜<span class="block Gray">2012年9月12日 15:17 / <a href="javascript:;" rel="0" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/2_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/2">koodo</a> @ <a href="/user/29">human</a>&nbsp;：诺基亚<span class="block Gray">2012年9月12日 15:46 / <a href="javascript:;" rel="1" actUID="2" onclick="javascript:rep(this,2);">回复</a></span></div></div><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default4.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/29">human</a> @ <a href="/user/2">koodo</a>&nbsp;：比诺基亚更强悍<span class="block Gray">2012年9月12日 16:02 / <a href="javascript:;" rel="2" actUID="29" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
