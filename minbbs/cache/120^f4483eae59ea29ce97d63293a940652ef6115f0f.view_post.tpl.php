...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d504323b2d96_35521986',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d504323b2d96_35521986')) {function content_52d504323b2d96_35521986($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>放假了！！</title>
        <meta name="description" content="放假了！！:放假了！！好无聊啊！！" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="120" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">放假了！！</h1>
                        <span id="vps-title-info">由 <a href="/user/29">human</a> 发表于 2012年9月25日 19:09</span>
                    </div>

                    <div class="autowarp" id="vps-content">放假了！！好无聊啊！！<img&nbsp;border="0"&nbsp;alt=""&nbsp;src="/mod/kd/plugins/emoticons/images/tsj/t_0017.gif"&nbsp;/></div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/2_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/2">koodo</a> / 2012年9月25日 19:26 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="2">回复</a></div>同感<div class="cms"></div></div></div><div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/12_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x677F;&#x51F3; / <a href="/user/12">坑爹的程序员</a> / 2012年9月27日 17:22 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="1" actUID="12">回复</a></div>国庆还要加班呢。<div class="cms"></div></div></div></div>
