...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d507db45d875_94532562',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d507db45d875_94532562')) {function content_52d507db45d875_94532562($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>IE下a的hover属性失效</title>
        <meta name="description" content="IE下a的hover属性失效:
	原来是我没加href属性，都没链接怎么触发hover呢。
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="223" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">IE下a的hover属性失效</h1>
                        <span id="vps-title-info">由 <a href="/user/201">Firing</a> 发表于 2012年11月11日 23:21</span>
                    </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/img/tavatar.gif" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/237">nenge</a> / 2012年11月15日 13:59 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="237">回复</a></div>这不对吧 hover是鼠标悬浮~<div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/minbbs/default/headimg/default7.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/201">Firing</a> @ <a href="/user/237">nenge</a>&nbsp;：在ie下如果&amp;lt;a&amp;gt;超级连接&amp;lt;/a&amp;gt;并没有href属性的话，鼠标放上去没有反应<span class="block Gray">2012年11月15日 16:00 / <a href="javascript:;" rel="0" actUID="201" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
