...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d61cf6b2c293_32721796',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d61cf6b2c293_32721796')) {function content_52d61cf6b2c293_32721796($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>请不要无意义回复或者灌水，违规者一经确认，将作删帖、禁言处理。</title>
        <meta name="description" content="请不要无意义回复或者灌水，违规者一经确认，将作删帖、禁言处理。:请不要无意义回复或者灌水，违规者一经确认，将作删帖、禁言处理。" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="78" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">请不要无意义回复或者灌水，违规者一经确认，将作删帖、禁言处理。</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月5日 12:49</span>
                    </div>

                    <div class="autowarp" id="vps-content">请不要无意义回复或者灌水，违规者一经确认，将作删帖、禁言处理。</div>
                </div>
