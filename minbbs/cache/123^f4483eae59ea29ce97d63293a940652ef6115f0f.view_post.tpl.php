...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d621c8512d45_58363334',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d621c8512d45_58363334')) {function content_52d621c8512d45_58363334($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Dojo 1.6 API文档已经上线了</title>
        <meta name="description" content="Dojo 1.6 API文档已经上线了:http://www.itsrcs.com/bookLib/127" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="123" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">Dojo 1.6 API文档已经上线了</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年9月29日 08:26</span>
                    </div>

                    <div class="autowarp" id="vps-content">http://www.itsrcs.com/bookLib/127</div>
                </div>
