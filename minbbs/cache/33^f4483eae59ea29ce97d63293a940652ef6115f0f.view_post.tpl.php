...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52d601e7989a82_66419964',
  'has_nocache_code' => false,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d601e7989a82_66419964')) {function content_52d601e7989a82_66419964($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>只会C语言，没搞过Cpp</title>
        <meta name="description" content="只会C语言，没搞过Cpp:只会C语言，没搞过Cpp" />
...
<![endif]-->
        <div class="sdCenter" style="margin-top:15px;">
            <input type=hidden value="33" id="postid" />
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">只会C语言，没搞过Cpp</h1>
                        <span id="vps-title-info">由 <a href="/user/2">koodo</a> 发表于 2012年8月19日 09:08</span>
                    </div>

                    <div class="autowarp" id="vps-content">只会C语言，没搞过Cpp</div>
                </div>
...
<div id="vps-comm-wapper">
    <div class="vps-wapper"><a class="headwapper"><img src="/user/data/head-img/19_head.jpg" class="Shadow"/></a><div class="Shadow vps-wapper-i"><s></s><i></i><div class="Gray">&#x6C99;&#x53D1; / <a href="/user/19">Serria</a> / 2012年9月5日 12:12 <a href="javascript:;" onclick="javascript:rep(this,1);" rel="0" actUID="19">回复</a></div>我会中文哦。<img src="/mod/kd/plugins/emoticons/images/jx2/j_0003.gif" border="0" alt="" /><div class="cms"><div class="sub-comm-item"><tx></tx><t></t><em class="ct-t-whw"><img src="/user/data/head-img/66_head.jpg" width="32px" height="32px"/></em><div style="margin-left:45px;line-height:20px;"><a href="/user/66">%E5%BD%B1%E5%AD%90</a> @ <a href="/user/19">Serria</a>&nbsp;：我精通普通话、潮汕话、白话，开玩笑的，纯属灌水<span class="block Gray">2012年9月6日 19:27 / <a href="javascript:;" rel="0" actUID="66" onclick="javascript:rep(this,2);">回复</a></span></div></div></div></div></div></div>
