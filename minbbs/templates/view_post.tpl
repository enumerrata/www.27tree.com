...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="description" content="{$BD.title}:{$SEO.desc}" />
        ...
        <div class="sdCenter" style="margin-top:15px;">
            ...
            <div class="ps-left">
                <div class="ps-items" id="vps-author">
                    <a id="vps-head" href="{$BD.uurl}"><img src="{$BD.ush}"/><span id="author-nickname">{$BD.usn}</span></a>
                </div>
            ...
            <div class="ps-right">
                <div class="ps-items" id="vps-body">
                    ...
                    <div id="vps-title-wapp">
                        <h1 class="autowrap" id="vps-title">{$BD.title}</h1>
                        <span id="vps-title-info">由 <a href="{$BD.uurl}">{$BD.usn}</a> 发表于 {$BD.time}</span>
                    </div>

                    <div class="autowarp" id="vps-content">{$BD.content}</div>
                </div>
                ...
                <!-- 回复按钮 -->
                <div class="ps-items">
                    {include file='./view_post_comm.tpl'}
